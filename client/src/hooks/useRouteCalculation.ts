 ...
 */
export function useRouteCalculation(tripStore: TripStoreState, selectedDayId: number | string | null) {
  ...
  const updateRouteForDay = useCallback(async (dayId: number | string | null) => {

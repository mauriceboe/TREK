const nl: Record<string, string> = {
  ...
  'settings.mfa.backupCodesTitle': 'Bewaar je back-upcodes',
  'settings.mfa.backupCodesIntro': 'Eenmalige codes om in te loggen als je je authenticator kwijtraakt. Elke code werkt maar één keer.',
  'settings.mfa.backupCodesWarning': 'Bewaar ze veilig. We tonen ze alleen hier, tenzij je nieuwe genereert.',
  'settings.mfa.backupCodesCopyAll': 'Alles kopiëren',
  'settings.mfa.backupCodesCopied': 'Gekopieerd naar klembord',
  'settings.mfa.backupCodesPrint': 'Afdrukken / Opslaan als PDF',
  'settings.mfa.backupCodesSaveTxt': 'Opslaan als .txt',
  'settings.mfa.backupCodesFileHeader': 'TREK — Back-upcodes voor tweestapsverificatie\nElke code is eenmalig. Bewaar dit bestand veilig.',
  'settings.mfa.backupCodesPrintFooter': 'TREK — Elke code is eenmalig. Bewaar deze afdruk veilig.',
  'settings.mfa.backupCodesPrintBlocked': 'Kan het printvenster niet openen. Sta pop-ups toe voor deze site.',
  'settings.mfa.backupCodesSavedTxt': 'Download gestart',
  'settings.mfa.backupCodesClose': 'Ik heb ze opgeslagen',
  'settings.mfa.backupCodesRemaining': '{count} back-upcodes over',
  'settings.mfa.backupCodesNone': 'Geen back-upcodes meer. Genereer hieronder nieuwe als je de authenticator verliest.',
  'settings.mfa.regenerateBackupTitle': 'Back-upcodes',
  'settings.mfa.regenerateBackupHint': 'Voer je wachtwoord en de huidige 6-cijferige code in. Oude back-upcodes worden ongeldig.',
  'settings.mfa.regenerateBackup': 'Nieuwe back-upcodes genereren',
  'settings.mfa.toastBackupRegenerated': 'Nieuwe back-upcodes gegenereerd',
  ...
  'login.mfaSubtitle': 'Voer de 6-cijferige code of een eenmalige back-upcode in.',
  'login.mfaCodeLabel': 'Verificatiecode',
  'login.mfaCodeRequired': 'Voer je authenticator- of back-upcode in.',
  'login.mfaHint': 'Gebruik je authenticator-app of een back-upcode als je geen toegang meer hebt.',

const nl: Record<string, string> = {
  ...
  'settings.roadtrip.title': 'Roadtrip',
  'settings.roadtrip.unitSystem': 'Eenhedenstelsel',
  'settings.roadtrip.metric': 'Metrisch',
  'settings.roadtrip.imperial': 'Imperiaal',
  'settings.roadtrip.vehicle': 'Voertuig',
  'settings.roadtrip.fuelPricePerLitre': 'Brandstofprijs (per liter)',
  'settings.roadtrip.fuelPricePerGallon': 'Brandstofprijs (per gallon)',
  'settings.roadtrip.fuelCurrency': 'Brandstofvaluta',
  'settings.roadtrip.fuelConsumptionMetric': 'Brandstofverbruik (L/100km)',
  'settings.roadtrip.fuelConsumptionImperial': 'Brandstofverbruik (MPG)',
  'settings.roadtrip.tankSizeLitres': 'Tankinhoud (liter)',
  'settings.roadtrip.tankSizeGallons': 'Tankinhoud (gallon)',
  'settings.roadtrip.drivingPreferences': 'Rijvoorkeuren',
  'settings.roadtrip.maxDrivingHours': 'Max. rijuren',
  'settings.roadtrip.restInterval': 'Rustinterval (uren)',
  'settings.roadtrip.restDuration': 'Rustduur (minuten)',
  'settings.roadtrip.maxSpeed': 'Maximumsnelheid',
  'settings.roadtrip.maxSpeedHelp': 'Beperkt de geschatte rijtijden op wegen met hogere snelheidslimieten. Laat leeg om de aangegeven snelheidslimieten te gebruiken.',
  'settings.roadtrip.routePreferences': 'Routevoorkeuren',
  'settings.roadtrip.daylightOnly': 'Alleen bij daglicht rijden',
  'settings.roadtrip.roadPreference': 'Wegvoorkeur',
  'settings.roadtrip.anyRoad': 'Elke weg',
  'settings.roadtrip.sealedOnly': 'Alleen verharde wegen',
  'settings.roadtrip.fuelPreferences': 'Brandstofvoorkeuren',
  'settings.roadtrip.fuelType': 'Brandstoftype',
  'settings.roadtrip.fuelBrand': 'Voorkeursmerk',
  'settings.roadtrip.fuelTypeAny': 'Elke brandstof',
  'settings.roadtrip.fuelTypeDiesel': 'Diesel',
  'settings.roadtrip.fuelTypePetrol': 'Benzine',
  'settings.roadtrip.brandAny': 'Elk merk',
  'settings.roadtrip.brandPreferred': 'Voorkeursmerk — andere worden getoond indien nodig',
  'settings.roadtrip.avoidFerries': 'Veerboten vermijden',
  'settings.roadtrip.preferHighways': 'Snelwegen voorkeur',
  'settings.roadtrip.truckSafe': 'Geschikt voor vrachtwagen / camper',
  'roadtrip.legActive': 'Roadtrip-route actief',
  'roadtrip.markLeg': 'Markeer als roadtrip-etappe',
  'roadtrip.toggleAll': 'Alle roadtrip-etappes wisselen',
  'roadtrip.summary': 'Roadtrip-overzicht',
  'roadtrip.totalDistance': 'Totale afstand',
  'roadtrip.totalTime': 'Rijtijd',
  'roadtrip.totalFuel': 'Brandstofkosten',
  'roadtrip.day': 'Dag',
  'roadtrip.distance': 'Afstand',
  'roadtrip.driveTime': 'Rijtijd',
  'roadtrip.fuelCost': 'Brandstof',
  'roadtrip.recalculateFuel': 'Brandstofkosten herberekenen',
  'roadtrip.recalculate': 'Herberekenen',
  'roadtrip.speedAdjusted': 'Rijtijden aangepast voor maximaal {speed}',
  'roadtrip.rangeWarning': 'Deze etappe ({distance}) overschrijdt het bereik van je voertuig ({range}). Tanken is noodzakelijk.',
  'roadtrip.fuelStopsEstimate': 'Geschatte tankstops: {count}',
  'roadtrip.exceedsRange': 'Overschrijdt voertuigbereik',
  'roadtrip.refuelPoint': 'Geschat tankpunt',
  'roadtrip.drivingTimeWarning': 'Rijtijd ({actual}) overschrijdt je dagelijkse limiet van {limit}',
  'roadtrip.restBreaks': '{count} rustpauzes (+{minutes} min)',
  'roadtrip.restStop': 'Aanbevolen rustpauze',
  'roadtrip.totalWithBreaks': 'Totaal met pauzes',
  'roadtrip.daylightWindow': '{sunrise} – {sunset} ({hours}u)',
  'roadtrip.daylightWarning': 'Rijtijd ({driving}) overschrijdt daglichturen ({daylight})',
  'roadtrip.daylightMode': 'Daglichtrijmodus actief',
  'roadtrip.truckSafeHelp': 'Vereist een zelf gehoste routeserver met vrachtwagenprofiel. De standaardserver gebruikt gewone autorouting.',
  'roadtrip.sealedOnlyHelp': 'Vereist een aangepast routeprofiel. De standaardserver kan onverharde wegen bevatten.',
  'roadtrip.exceedsDaylight': 'Overschrijdt beschikbare daglichturen',
  'roadtrip.estimatedRange': 'Geschat bereik: {range}',
  'roadtrip.driving': 'Rijden',
  'roadtrip.pdfDrivingSummary': 'Rijoverzicht',
  'roadtrip.pdfTripTotal': 'Totaal reis',
  'roadtrip.toggleAllTrip': 'Alle roadtrip-etappes wisselen',
  'roadtrip.calculatingRoutes': 'Routes berekenen…',
  'roadtrip.showFullRoute': 'Volledige reisroute tonen',
  'roadtrip.directions': 'Routebeschrijving',
  'roadtrip.directionsOmitted': 'Routebeschrijving weggelaten voor etappes langer dan 800 km',
  'roadtrip.directionCount': '{count} aanwijzingen',
  'roadtrip.arrive': 'Aankomst op bestemming',
  'roadtrip.depart': 'Vertrek',
  'roadtrip.findStops': 'Stops zoeken',
  'roadtrip.stopsFound': '{count} stops gevonden',
  'roadtrip.stopSource': 'Stopgegevensbron',
  'roadtrip.stopSourceOsm': 'OpenStreetMap (gratis)',
  'roadtrip.stopSourceGoogle': 'Google Places (rijkere gegevens)',
  'roadtrip.stopSourceHelp': 'Bron voor het zoeken van tankstations en rustplaatsen langs de route.',
  'roadtrip.stopSourceGoogleDisabled': 'Google Places vereist een Google Maps API-sleutel die door de beheerder is geconfigureerd.',
  'roadtrip.realFuelStop': 'tankstation',
  'roadtrip.realRestStop': 'rustplaats',
  'roadtrip.openInMaps': 'Openen in Google Maps',
  'roadtrip.approximateStop': 'Geschatte stop',
  'roadtrip.refreshStops': 'Vernieuwen',
  'roadtrip.findingStops': 'Stops zoeken…',
  'roadtrip.recommendedDeparture': 'Vertrek na',
  'roadtrip.arrivalBefore': 'Aankomst voor',
  'roadtrip.drivingWindow': 'Rijvenster',
  'roadtrip.departBy': 'Vertrek om {time} · Aankomst om {arrival}',
  'roadtrip.insufficientDaylight': 'Niet genoeg daglicht voor deze rit. Overweeg om het over twee dagen te verdelen.',
  'roadtrip.setCheckout': 'Check-out instellen',
  'roadtrip.setCheckin': 'Check-in instellen',
  'roadtrip.checkoutUpdated': 'Check-out tijd bijgewerkt',
  'roadtrip.checkinUpdated': 'Check-in tijd bijgewerkt',
  'roadtrip.daylightOk': 'Daglichttijd OK',
  'roadtrip.bookingsSafe': 'Uw check-out ({checkout}) en check-in ({checkin}) vallen binnen het veilige daglichtvenster',
  'roadtrip.checkoutTooEarly': 'Check-out ({time}) is vóór veilig vertrek ({safe})',
  'roadtrip.checkinTooLate': 'Check-in ({time}) is na veilige aankomst ({safe})',
  'roadtrip.criticalFuelStop': 'Moet tanken',
  'roadtrip.optionalFuelStop': 'Beschikbaar',
  'roadtrip.mustRefuel': 'TANKEN',
  'roadtrip.fuelAvailable': 'Beschikbaar',
  'roadtrip.tripFuelPrice': 'Brandstofprijs',
  'roadtrip.tripFuelPriceHelp': 'Brandstofprijs specifiek voor deze reis',
  'roadtrip.tripOverride': 'reisprijs',
  'roadtrip.noPreferredBrand': 'Geen stations van voorkeursmerk gevonden',
  'settings.roadtrip.stopSource': 'Stop zoeken',
  ...
  'atlas.totalDriven': 'Totaal gereden',
  'atlas.totalRoadTrips': 'Roadtrips',
  'atlas.totalDrivingTime': 'Rijtijd',
  'atlas.totalFuelSpent': 'Brandstofkosten',
  'atlas.longestTrip': 'Langste reis',
  'atlas.longestDay': 'Langste dag',
  'atlas.tripLegend': 'Reizen',
  'atlas.viewTrip': 'Reis bekijken',
  'atlas.noRoadTrips': 'Nog geen roadtripgegevens. Markeer etappes als roadtrips in je reisplannen om ze hier te zien.',

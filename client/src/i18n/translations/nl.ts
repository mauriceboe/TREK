const nl: Record<string, string> = {
  ...
  'packing.type.shared': 'gedeeld',
  'packing.type.personal': 'persoonlijk',
  'packing.type.private': 'privé',
  'packing.type.shared.hint': 'Zichtbaar voor iedereen. Vinkjes worden gedeeld.',
  'packing.type.personal.hint': 'Zichtbaar voor iedereen, maar iedereen beheert zijn eigen vinkjes.',
  'packing.type.private.hint': 'Alleen jij ziet deze categorie en haar items.',
  'packing.type.makeShared': 'Gedeeld maken',
  'packing.type.makePersonal': 'Persoonlijk maken',
  'packing.type.makePrivate': 'Privé maken',
  'packing.categoryExists': 'Categorie bestaat al',
  ...
  'packing.saveAsTemplate.hint': 'Privé-categorieën worden niet opgenomen.',

const fr: Record<string, string> = {
  ...
  'packing.type.shared': 'partagé',
  'packing.type.personal': 'personnel',
  'packing.type.private': 'privé',
  'packing.type.shared.hint': 'Visible par tous. Les coches sont partagées.',
  'packing.type.personal.hint': 'Visible par tous, mais chacun gère ses propres coches.',
  'packing.type.private.hint': 'Vous seul voyez cette catégorie et ses articles.',
  'packing.type.makeShared': 'Rendre partagé',
  'packing.type.makePersonal': 'Rendre personnel',
  'packing.type.makePrivate': 'Rendre privé',
  'packing.categoryExists': 'La catégorie existe déjà',
  ...
  'packing.saveAsTemplate.hint': 'Les catégories privées ne sont pas incluses.',

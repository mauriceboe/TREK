const fr: Record<string, string> = {
  ...
  'settings.roadtrip.unitSystem': 'Système d\'unités',
  'settings.roadtrip.metric': 'Métrique',
  'settings.roadtrip.imperial': 'Impérial',
  'settings.roadtrip.vehicle': 'Véhicule',
  'settings.roadtrip.fuelPricePerLitre': 'Prix du carburant (par litre)',
  'settings.roadtrip.fuelPricePerGallon': 'Prix du carburant (par gallon)',
  'settings.roadtrip.fuelCurrency': 'Devise du carburant',
  'settings.roadtrip.fuelConsumptionMetric': 'Consommation de carburant (L/100km)',
  'settings.roadtrip.fuelConsumptionImperial': 'Rendement énergétique (MPG)',
  'settings.roadtrip.tankSizeLitres': 'Taille du réservoir (litres)',
  'settings.roadtrip.tankSizeGallons': 'Taille du réservoir (gallons)',
  'settings.roadtrip.drivingPreferences': 'Préférences de conduite',
  'settings.roadtrip.maxDrivingHours': 'Heures de conduite max.',
  'settings.roadtrip.restInterval': 'Intervalle de repos (heures)',
  'settings.roadtrip.restDuration': 'Durée du repos (minutes)',
  'settings.roadtrip.maxSpeed': 'Vitesse maximale',
  'settings.roadtrip.maxSpeedHelp': 'Limite les temps de conduite estimés sur les routes avec des limites de vitesse plus élevées. Laisser vide pour utiliser les limites affichées.',
  'settings.roadtrip.routePreferences': 'Préférences d\'itinéraire',
  'settings.roadtrip.daylightOnly': 'Conduite de jour uniquement',
  'settings.roadtrip.roadPreference': 'Préférence de route',
  'settings.roadtrip.anyRoad': 'Toute route',
  'settings.roadtrip.sealedOnly': 'Routes goudronnées uniquement',
  'settings.roadtrip.fuelPreferences': 'Préférences carburant',
  'settings.roadtrip.fuelType': 'Type de carburant',
  'settings.roadtrip.fuelBrand': 'Marque préférée',
  'settings.roadtrip.fuelTypeAny': 'Tout carburant',
  'settings.roadtrip.fuelTypeDiesel': 'Diesel',
  'settings.roadtrip.fuelTypePetrol': 'Essence',
  'settings.roadtrip.brandAny': 'Toute marque',
  'settings.roadtrip.brandPreferred': 'Marque préférée — autres affichées si nécessaire',
  'settings.roadtrip.avoidFerries': 'Éviter les ferries',
  'settings.roadtrip.preferHighways': 'Préférer les autoroutes',
  'settings.roadtrip.truckSafe': 'Adapté camions / camping-cars',
  'roadtrip.legActive': 'Itinéraire road trip actif',
  'roadtrip.markLeg': 'Marquer comme étape du road trip',
  'roadtrip.toggleAll': 'Basculer toutes les étapes du road trip',
  'roadtrip.summary': 'Résumé du road trip',
  'roadtrip.totalDistance': 'Distance totale',
  'roadtrip.totalTime': 'Temps de conduite',
  'roadtrip.totalFuel': 'Coût du carburant',
  'roadtrip.day': 'Jour',
  'roadtrip.distance': 'Distance',
  'roadtrip.driveTime': 'Temps de conduite',
  'roadtrip.fuelCost': 'Carburant',
  'roadtrip.recalculateFuel': 'Recalculer les coûts de carburant',
  'roadtrip.recalculate': 'Recalculer',
  'roadtrip.speedAdjusted': 'Temps de conduite ajustés pour une vitesse maximale de {speed}',
  'roadtrip.rangeWarning': 'Cette étape ({distance}) dépasse l\'autonomie de votre véhicule ({range}). Un ravitaillement sera nécessaire.',
  'roadtrip.fuelStopsEstimate': 'Arrêts carburant estimés : {count}',
  'roadtrip.exceedsRange': 'Dépasse l\'autonomie du véhicule',
  'roadtrip.refuelPoint': 'Point de ravitaillement approximatif',
  'roadtrip.drivingTimeWarning': 'Le temps de conduite ({actual}) dépasse votre limite quotidienne de {limit}',
  'roadtrip.restBreaks': '{count} pauses repos (+{minutes} min)',
  'roadtrip.restStop': 'Pause repos recommandée',
  'roadtrip.totalWithBreaks': 'Total avec pauses',
  'roadtrip.daylightWindow': '{sunrise} – {sunset} ({hours}h)',
  'roadtrip.daylightWarning': 'La conduite ({driving}) dépasse les heures de jour ({daylight})',
  'roadtrip.daylightMode': 'Mode conduite de jour actif',
  'roadtrip.truckSafeHelp': 'Nécessite un serveur de routage auto-hébergé avec profil camion. Le serveur par défaut utilise le routage voiture standard.',
  'roadtrip.sealedOnlyHelp': 'Nécessite un profil de routage personnalisé. Le serveur par défaut peut inclure des routes non goudronnées.',
  'roadtrip.exceedsDaylight': 'Dépasse les heures de jour disponibles',
  'roadtrip.estimatedRange': 'Autonomie estimée : {range}',
  'roadtrip.driving': 'Conduite',
  'roadtrip.pdfDrivingSummary': 'Résumé de conduite',
  'roadtrip.pdfTripTotal': 'Total du voyage',
  'roadtrip.toggleAllTrip': 'Basculer toutes les étapes du road trip',
  'roadtrip.calculatingRoutes': 'Calcul des itinéraires…',
  'roadtrip.showFullRoute': 'Afficher l\'itinéraire complet',
  'roadtrip.directions': 'Itinéraire',
  'roadtrip.directionsOmitted': 'Itinéraire omis pour les étapes de plus de 800 km',
  'roadtrip.directionCount': '{count} directions',
  'roadtrip.arrive': 'Arrivée à destination',
  'roadtrip.depart': 'Départ',
  'roadtrip.findStops': 'Chercher des arrêts',
  'roadtrip.stopsFound': '{count} arrêts trouvés',
  'roadtrip.stopSource': 'Source des données d\'arrêts',
  'roadtrip.stopSourceOsm': 'OpenStreetMap (gratuit)',
  'roadtrip.stopSourceGoogle': 'Google Places (données enrichies)',
  'roadtrip.stopSourceHelp': 'Source pour la recherche de stations-service et aires de repos le long de l\'itinéraire.',
  'roadtrip.stopSourceGoogleDisabled': 'Google Places nécessite une clé API Google Maps configurée par l\'administrateur.',
  'roadtrip.realFuelStop': 'station-service',
  'roadtrip.realRestStop': 'aire de repos',
  'roadtrip.openInMaps': 'Ouvrir dans Google Maps',
  'roadtrip.approximateStop': 'Arrêt approximatif',
  'roadtrip.refreshStops': 'Actualiser',
  'roadtrip.findingStops': 'Recherche d\'arrêts…',
  'roadtrip.recommendedDeparture': 'Partir après',
  'roadtrip.arrivalBefore': 'Arriver avant',
  'roadtrip.drivingWindow': 'Créneau de conduite',
  'roadtrip.departBy': 'Partir à {time} · Arriver à {arrival}',
  'roadtrip.insufficientDaylight': 'Pas assez de lumière du jour pour ce trajet. Envisagez de le répartir sur deux jours.',
  'roadtrip.setCheckout': 'Définir le check-out',
  'roadtrip.setCheckin': 'Définir le check-in',
  'roadtrip.checkoutUpdated': 'Heure de check-out mise à jour',
  'roadtrip.checkinUpdated': 'Heure de check-in mise à jour',
  'roadtrip.daylightOk': 'Conduite de jour OK',
  'roadtrip.bookingsSafe': 'Votre check-out ({checkout}) et check-in ({checkin}) sont dans la fenêtre de jour sûre',
  'roadtrip.checkoutTooEarly': 'Check-out ({time}) est avant le départ sûr ({safe})',
  'roadtrip.checkinTooLate': 'Check-in ({time}) est après l\'arrivée sûre ({safe})',
  'roadtrip.criticalFuelStop': 'Ravitaillement obligatoire',
  'roadtrip.optionalFuelStop': 'Disponible',
  'roadtrip.mustRefuel': 'RAVITAILLER',
  'roadtrip.fuelAvailable': 'Disponible',
  'roadtrip.tripFuelPrice': 'Prix du carburant',
  'roadtrip.tripFuelPriceHelp': 'Prix du carburant spécifique à ce voyage',
  'roadtrip.tripOverride': 'prix du voyage',
  'roadtrip.noPreferredBrand': 'Aucune station de la marque préférée trouvée',
  'settings.roadtrip.stopSource': 'Recherche d\'arrêts',
  ...
  'atlas.roadTrips': 'Road trips',
  'atlas.totalDriven': 'Total parcouru',
  'atlas.totalRoadTrips': 'Road trips',
  'atlas.totalDrivingTime': 'Temps de conduite',
  'atlas.totalFuelSpent': 'Dépenses carburant',
  'atlas.longestTrip': 'Plus long voyage',
  'atlas.longestDay': 'Plus longue journée',
  'atlas.tripLegend': 'Voyages',
  'atlas.viewTrip': 'Voir le voyage',
  'atlas.noRoadTrips': 'Pas encore de données de road trip. Marquez des étapes comme road trips dans vos plans pour les voir ici.',

const fr: Record<string, string> = {
  ...
  'settings.mfa.backupCodesTitle': 'Enregistrez vos codes de secours',
  'settings.mfa.backupCodesIntro': 'Codes à usage unique pour vous connecter si vous perdez l’authentificateur. Chaque code ne fonctionne qu’une fois.',
  'settings.mfa.backupCodesWarning': 'Conservez-les en lieu sûr. Nous ne les affichons qu’ici, sauf si vous en générez de nouveaux.',
  'settings.mfa.backupCodesCopyAll': 'Tout copier',
  'settings.mfa.backupCodesCopied': 'Copié dans le presse-papiers',
  'settings.mfa.backupCodesPrint': 'Imprimer / Enregistrer en PDF',
  'settings.mfa.backupCodesSaveTxt': 'Enregistrer en .txt',
  'settings.mfa.backupCodesFileHeader': 'TREK — Codes de secours d’authentification à deux facteurs\nChaque code est à usage unique. Conservez ce fichier en lieu sûr.',
  'settings.mfa.backupCodesPrintFooter': 'TREK — Chaque code est à usage unique. Conservez cette impression.',
  'settings.mfa.backupCodesPrintBlocked': 'Impossible d’ouvrir la fenêtre d’impression. Autorisez les pop-ups pour ce site.',
  'settings.mfa.backupCodesSavedTxt': 'Téléchargement lancé',
  'settings.mfa.backupCodesClose': 'Je les ai enregistrés',
  'settings.mfa.backupCodesRemaining': '{count} codes de secours restants',
  'settings.mfa.backupCodesNone': 'Aucun code de secours. Générez-en de nouveaux ci-dessous si vous perdez l’authentificateur.',
  'settings.mfa.regenerateBackupTitle': 'Codes de secours',
  'settings.mfa.regenerateBackupHint': 'Saisissez votre mot de passe et le code à 6 chiffres actuel. Les anciens codes seront invalidés.',
  'settings.mfa.regenerateBackup': 'Générer de nouveaux codes de secours',
  'settings.mfa.toastBackupRegenerated': 'Nouveaux codes de secours générés',
  ...
  'login.mfaSubtitle': 'Entrez le code à 6 chiffres ou un code de secours à usage unique.',
  'login.mfaCodeLabel': 'Code de vérification',
  'login.mfaCodeRequired': 'Entrez le code d’authentification ou un code de secours.',
  'login.mfaHint': 'Utilisez votre application d’authentification ou un code de secours si vous n’avez plus accès.',

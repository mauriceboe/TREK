const de: Record<string, string | { name: string; category: string }[]> = {
  ...
  'admin.update.dataInfo': 'Alle Daten (Reisen, Benutzer, API-Schlüssel, Uploads, Vacay, Atlas, Budgets, Kosten) bleiben erhalten.',
  ...
  // Kosten addon
  'trip.tabs.kosten': 'Kosten',
  'kosten.subtitle': 'Ausgaben aufteilen und abrechnen',
  'kosten.addExpense': 'Ausgabe hinzufügen',
  'kosten.editExpense': 'Ausgabe bearbeiten',
  'kosten.deleteExpenseConfirm': 'Diese Ausgabe wirklich löschen?',
  'kosten.tabExpenses': 'Ausgaben',
  'kosten.tabSettlement': 'Abrechnung',
  'kosten.expenseTitle': 'Titel',
  'kosten.amount': 'Betrag',
  'kosten.currency': 'Währung',
  'kosten.exchangeRate': 'Wechselkurs',
  'kosten.exchangeRateHint': '1 {from} = {rate} {to}',
  'kosten.fetchRate': 'Kurs abrufen',
  'kosten.convertedAmount': '≈ {amount} {currency}',
  'kosten.paidBy': 'Bezahlt von',
  'kosten.category': 'Kategorie',
  'kosten.date': 'Datum',
  'kosten.note': 'Notiz',
  'kosten.splitType': 'Aufteilung',
  'kosten.splitEqual': 'Gleich',
  'kosten.splitAmount': 'Nach Betrag',
  'kosten.splitPercent': 'Nach Prozent',
  'kosten.participants': 'Beteiligte',
  'kosten.perPerson': 'pro Person',
  'kosten.totalSpent': 'Gesamtausgaben',
  'kosten.noExpenses': 'Noch keine Ausgaben',
  'kosten.noExpensesHint': 'Füge die erste Ausgabe hinzu',
  ...
  'kosten.addSettlement': 'Ausgleich entrichten',
  'kosten.fromUser': 'Von',
  'kosten.toUser': 'An',
  'kosten.deleteSettlementConfirm': 'Diesen Ausgleich wirklich löschen?',
  'kosten.pdfExport': 'PDF',
  'kosten.pdfTitle': 'Kostenabrechnung',
  'kosten.perPersonTitle': 'Pro Person',
  'kosten.cat.accommodation': 'Unterkunft',
  'kosten.cat.transport': 'Transport',
  'kosten.cat.food': 'Essen & Trinken',
  'kosten.cat.activities': 'Aktivitäten',
  'kosten.cat.shopping': 'Einkaufen',

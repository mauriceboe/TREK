const de: Record<string, string | { name: string; category: string }[]> = {
  ...
  'settings.roadtrip.unitSystem': 'Einheitensystem',
  'settings.roadtrip.metric': 'Metrisch',
  'settings.roadtrip.imperial': 'Imperial',
  'settings.roadtrip.vehicle': 'Fahrzeug',
  'settings.roadtrip.fuelPricePerLitre': 'Kraftstoffpreis (pro Liter)',
  'settings.roadtrip.fuelPricePerGallon': 'Kraftstoffpreis (pro Gallone)',
  'settings.roadtrip.fuelCurrency': 'Kraftstoffwährung',
  'settings.roadtrip.fuelConsumptionMetric': 'Kraftstoffverbrauch (L/100km)',
  'settings.roadtrip.fuelConsumptionImperial': 'Kraftstoffverbrauch (MPG)',
  'settings.roadtrip.tankSizeLitres': 'Tankgröße (Liter)',
  'settings.roadtrip.tankSizeGallons': 'Tankgröße (Gallonen)',
  'settings.roadtrip.drivingPreferences': 'Fahrpräferenzen',
  'settings.roadtrip.maxDrivingHours': 'Max. Fahrstunden',
  'settings.roadtrip.restInterval': 'Pausenintervall (Stunden)',
  'settings.roadtrip.restDuration': 'Pausendauer (Minuten)',
  'settings.roadtrip.maxSpeed': 'Höchstgeschwindigkeit',
  'settings.roadtrip.maxSpeedHelp': 'Begrenzt die geschätzte Fahrzeit auf Straßen mit höheren Geschwindigkeitsbegrenzungen. Leer lassen, um die ausgeschilderten Limits zu verwenden.',
  'settings.roadtrip.routePreferences': 'Routenpräferenzen',
  'settings.roadtrip.daylightOnly': 'Nur bei Tageslicht fahren',
  'settings.roadtrip.roadPreference': 'Straßenpräferenz',
  'settings.roadtrip.anyRoad': 'Alle Straßen',
  'settings.roadtrip.sealedOnly': 'Nur asphaltiert',
  'settings.roadtrip.fuelPreferences': 'Kraftstoff-Präferenzen',
  'settings.roadtrip.fuelType': 'Kraftstoffart',
  'settings.roadtrip.fuelBrand': 'Bevorzugte Marke',
  'settings.roadtrip.fuelTypeAny': 'Beliebig',
  'settings.roadtrip.fuelTypeDiesel': 'Diesel',
  'settings.roadtrip.fuelTypePetrol': 'Benzin',
  'settings.roadtrip.brandAny': 'Beliebige Marke',
  'settings.roadtrip.brandPreferred': 'Bevorzugte Marke — andere werden bei Bedarf angezeigt',
  'settings.roadtrip.avoidFerries': 'Fähren vermeiden',
  'settings.roadtrip.preferHighways': 'Autobahnen bevorzugen',
  'settings.roadtrip.truckSafe': 'LKW / Wohnmobil geeignet',
  'roadtrip.legActive': 'Road-Trip-Route aktiv',
  'roadtrip.markLeg': 'Als Road-Trip-Etappe markieren',
  'roadtrip.toggleAll': 'Alle Road-Trip-Etappen umschalten',
  'roadtrip.summary': 'Road-Trip-Zusammenfassung',
  'roadtrip.totalDistance': 'Gesamtstrecke',
  'roadtrip.totalTime': 'Fahrzeit',
  'roadtrip.totalFuel': 'Kraftstoffkosten',
  'roadtrip.day': 'Tag',
  'roadtrip.distance': 'Strecke',
  'roadtrip.driveTime': 'Fahrzeit',
  'roadtrip.fuelCost': 'Kraftstoff',
  'roadtrip.recalculateFuel': 'Kraftstoffkosten neu berechnen',
  'roadtrip.recalculate': 'Neu berechnen',
  'roadtrip.speedAdjusted': 'Fahrzeiten angepasst für {speed} Höchstgeschwindigkeit',
  'roadtrip.rangeWarning': 'Diese Etappe ({distance}) überschreitet die Fahrzeugreichweite ({range}). Tanken wird nötig sein.',
  'roadtrip.fuelStopsEstimate': 'Geschätzte Tankstopps: {count}',
  'roadtrip.exceedsRange': 'Überschreitet Fahrzeugreichweite',
  'roadtrip.refuelPoint': 'Ungefährer Tankpunkt',
  'roadtrip.drivingTimeWarning': 'Fahrzeit ({actual}) überschreitet das {limit}-Tageslimit',
  'roadtrip.restBreaks': '{count} Pausen (+{minutes} min)',
  'roadtrip.restStop': 'Empfohlene Rast',
  'roadtrip.totalWithBreaks': 'Gesamt mit Pausen',
  'roadtrip.daylightWindow': '{sunrise} – {sunset} ({hours}h)',
  'roadtrip.daylightWarning': 'Fahrzeit ({driving}) überschreitet Tageslicht ({daylight})',
  'roadtrip.daylightMode': 'Tageslicht-Fahrmodus aktiv',
  'roadtrip.truckSafeHelp': 'Erfordert einen selbst gehosteten Routingserver mit LKW-Profil. Der Standardserver nutzt PKW-Routing.',
  'roadtrip.sealedOnlyHelp': 'Erfordert ein benutzerdefiniertes Routingprofil. Der Standardserver kann unbefestigte Straßen einbeziehen.',
  'roadtrip.exceedsDaylight': 'Überschreitet verfügbare Tageslichtstunden',
  'roadtrip.estimatedRange': 'Geschätzte Reichweite: {range}',
  'roadtrip.driving': 'Fahrstrecke',
  'roadtrip.pdfDrivingSummary': 'Fahrtübersicht',
  'roadtrip.pdfTripTotal': 'Gesamtübersicht',
  'roadtrip.toggleAllTrip': 'Alle Road-Trip-Etappen umschalten',
  'roadtrip.calculatingRoutes': 'Routen werden berechnet…',
  'roadtrip.showFullRoute': 'Gesamte Reiseroute anzeigen',
  'roadtrip.directions': 'Wegbeschreibung',
  'roadtrip.directionsOmitted': 'Wegbeschreibung für Etappen über 800 km ausgelassen',
  'roadtrip.directionCount': '{count} Anweisungen',
  'roadtrip.arrive': 'Am Ziel ankommen',
  'roadtrip.depart': 'Abfahrt',
  'roadtrip.findStops': 'Stopps finden',
  'roadtrip.stopsFound': '{count} Stopps gefunden',
  'roadtrip.stopSource': 'Stopp-Datenquelle',
  'roadtrip.stopSourceOsm': 'OpenStreetMap (kostenlos)',
  'roadtrip.stopSourceGoogle': 'Google Places (mehr Daten)',
  'roadtrip.stopSourceHelp': 'Quelle für Tankstellen- und Rastplatz-Suche entlang der Route.',
  'roadtrip.stopSourceGoogleDisabled': 'Google Places erfordert einen Google Maps API-Schlüssel, der vom Administrator konfiguriert wurde.',
  'roadtrip.realFuelStop': 'Tankstelle',
  'roadtrip.realRestStop': 'Rastplatz',
  'roadtrip.openInMaps': 'In Google Maps öffnen',
  'roadtrip.approximateStop': 'Ungefährer Stopp',
  'roadtrip.refreshStops': 'Aktualisieren',
  'roadtrip.findingStops': 'Stopps werden gesucht…',
  'roadtrip.recommendedDeparture': 'Abfahrt nach',
  'roadtrip.arrivalBefore': 'Ankunft vor',
  'roadtrip.drivingWindow': 'Fahrzeitfenster',
  'roadtrip.departBy': 'Abfahrt um {time} · Ankunft um {arrival}',
  'roadtrip.insufficientDaylight': 'Nicht genug Tageslicht für diese Fahrt. Erwägen Sie, die Strecke auf zwei Tage aufzuteilen.',
  'roadtrip.setCheckout': 'Check-out festlegen',
  'roadtrip.setCheckin': 'Check-in festlegen',
  'roadtrip.checkoutUpdated': 'Check-out-Zeit aktualisiert',
  'roadtrip.checkinUpdated': 'Check-in-Zeit aktualisiert',
  'roadtrip.daylightOk': 'Tageslichtfahrt OK',
  'roadtrip.bookingsSafe': 'Ihr Check-out ({checkout}) und Check-in ({checkin}) liegen im sicheren Tageslichtzeitfenster',
  'roadtrip.checkoutTooEarly': 'Check-out ({time}) ist vor der sicheren Abfahrt ({safe})',
  'roadtrip.checkinTooLate': 'Check-in ({time}) ist nach der sicheren Ankunft ({safe})',
  'roadtrip.criticalFuelStop': 'Muss tanken',
  'roadtrip.optionalFuelStop': 'Verfügbar',
  'roadtrip.mustRefuel': 'TANKEN',
  'roadtrip.fuelAvailable': 'Verfügbar',
  'roadtrip.tripFuelPrice': 'Kraftstoffpreis',
  'roadtrip.tripFuelPriceHelp': 'Kraftstoffpreis für diese Reise',
  'roadtrip.tripOverride': 'Reisepreis',
  'roadtrip.noPreferredBrand': 'Keine Tankstellen der bevorzugten Marke gefunden',
  'settings.roadtrip.stopSource': 'Stopp-Suche',
  ...
  'atlas.roadTrips': 'Roadtrips',
  'atlas.totalDriven': 'Gesamtstrecke',
  'atlas.totalRoadTrips': 'Roadtrips',
  'atlas.totalDrivingTime': 'Fahrzeit',
  'atlas.totalFuelSpent': 'Kraftstoffkosten',
  'atlas.longestTrip': 'Längste Reise',
  'atlas.longestDay': 'Längster Tag',
  'atlas.tripLegend': 'Reisen',
  'atlas.viewTrip': 'Reise ansehen',
  'atlas.noRoadTrips': 'Noch keine Roadtrip-Daten. Markieren Sie Etappen als Roadtrips in Ihren Reiseplänen, um sie hier zu sehen.',

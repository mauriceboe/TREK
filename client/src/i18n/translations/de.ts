const de: Record<string, string | { name: string; category: string }[]> = {
  ...
  'packing.type.shared': 'geteilt',
  'packing.type.personal': 'persönlich',
  'packing.type.private': 'privat',
  'packing.type.shared.hint': 'Für alle sichtbar. Häkchen werden geteilt.',
  'packing.type.personal.hint': 'Für alle sichtbar, aber jeder verwaltet seine eigenen Häkchen.',
  'packing.type.private.hint': 'Nur du siehst diese Kategorie und ihre Einträge.',
  'packing.type.makeShared': 'Geteilt machen',
  'packing.type.makePersonal': 'Persönlich machen',
  'packing.type.makePrivate': 'Privat machen',
  'packing.categoryExists': 'Kategorie existiert bereits',
  ...
  'packing.saveAsTemplate.hint': 'Private Kategorien werden nicht aufgenommen.',

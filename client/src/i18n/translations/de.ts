const de: Record<string, string | { name: string; category: string }[]> = {
  ...
  'packing.useCamera': 'Kamera benutzen',
  'packing.uploadImage': 'Bild hochladen',
  'packing.processingImage': 'Bild wird analysiert...',
  'packing.startingCamera': 'Kamera wird gestartet...',
  'packing.qrNoCodeFound': 'Kein QR-Code im Bild gefunden. Bitte stelle sicher, dass der QR-Code klar, gut beleuchtet und nicht verschwommen ist.',

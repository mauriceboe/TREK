const de: Record<string, string | { name: string; category: string }[]> = {
  ...
  'settings.mfa.backupCodesTitle': 'Backup-Codes speichern',
  'settings.mfa.backupCodesIntro': 'Einmalige Codes für die Anmeldung, falls du den Authenticator verlierst. Jeder Code ist nur einmal gültig.',
  'settings.mfa.backupCodesWarning': 'Bewahre sie sicher auf. Wir zeigen sie nur hier – außer du erzeugst neue.',
  'settings.mfa.backupCodesCopyAll': 'Alle kopieren',
  'settings.mfa.backupCodesCopied': 'In die Zwischenablage kopiert',
  'settings.mfa.backupCodesPrint': 'Drucken / Als PDF speichern',
  'settings.mfa.backupCodesSaveTxt': 'Als .txt speichern',
  'settings.mfa.backupCodesFileHeader': 'TREK — Zwei-Faktor-Authentifizierung: Backup-Codes\nJeder Code ist nur einmal gültig. Datei sicher aufbewahren.',
  'settings.mfa.backupCodesPrintFooter': 'TREK — Jeder Code ist einmalig. Ausdruck sicher aufbewahren.',
  'settings.mfa.backupCodesPrintBlocked': 'Druckfenster konnte nicht geöffnet werden. Pop-ups für diese Seite erlauben.',
  'settings.mfa.backupCodesSavedTxt': 'Download gestartet',
  'settings.mfa.backupCodesClose': 'Ich habe sie gespeichert',
  'settings.mfa.backupCodesRemaining': '{count} Backup-Codes übrig',
  'settings.mfa.backupCodesNone': 'Keine Backup-Codes mehr. Erzeuge unten neue, falls du den Authenticator verlierst.',
  'settings.mfa.regenerateBackupTitle': 'Backup-Codes',
  'settings.mfa.regenerateBackupHint': 'Passwort und aktuellen 6-stelligen Code aus der Authenticator-App eingeben. Alte Backup-Codes werden ungültig.',
  'settings.mfa.regenerateBackup': 'Neue Backup-Codes erzeugen',
  'settings.mfa.toastBackupRegenerated': 'Neue Backup-Codes erzeugt',
  ...
  'login.mfaSubtitle': 'Gib den 6-stelligen Code aus der Authenticator-App oder einen Backup-Code ein.',
  'login.mfaCodeLabel': 'Bestätigungscode',
  'login.mfaCodeRequired': 'Authenticator- oder Backup-Code eingeben.',
  'login.mfaHint': 'Authenticator-App nutzen oder einen Backup-Code, falls kein Zugriff mehr besteht.',

const zhTw: Record<string, string> = {
  ...
  'packing.type.personal': '個人',
  'packing.type.private': '私密',
  'packing.type.shared.hint': '所有人可見，勾選狀態共享。',
  'packing.type.personal.hint': '所有人可見，但每個人獨立管理自己的勾選。',
  'packing.type.private.hint': '僅你可見此分類及其條目。',
  'packing.type.makeShared': '設為共享',
  'packing.type.makePersonal': '設為個人',
  'packing.type.makePrivate': '設為私密',
  'packing.categoryExists': '分類已存在',
  ...
  'packing.saveAsTemplate.hint': '私密分類不會包含在內。',

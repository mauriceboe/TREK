const zh: Record<string, string> = {
  ...
  'packing.type.shared': '共享',
  'packing.type.personal': '个人',
  'packing.type.private': '私密',
  'packing.type.shared.hint': '所有人可见，勾选状态共享。',
  'packing.type.personal.hint': '所有人可见，但每个人独立管理自己的勾选。',
  'packing.type.private.hint': '仅你可见此分类及其条目。',
  'packing.type.makeShared': '设为共享',
  'packing.type.makePersonal': '设为个人',
  'packing.type.makePrivate': '设为私密',
  'packing.categoryExists': '分类已存在',
  ...
  'packing.saveAsTemplate.hint': '私密分类不会包含在内。',

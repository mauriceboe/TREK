const zh: Record<string, string> = {
  ...
  'settings.mfa.backupCodesTitle': '请保存备用验证码',
  'settings.mfa.backupCodesIntro': '若丢失身份验证器，可用这些一次性验证码登录。每个验证码仅可使用一次。',
  'settings.mfa.backupCodesWarning': '请妥善保管。除重新生成外，仅在此显示一次。',
  'settings.mfa.backupCodesCopyAll': '全部复制',
  'settings.mfa.backupCodesCopied': '已复制到剪贴板',
  'settings.mfa.backupCodesPrint': '打印 / 另存为 PDF',
  'settings.mfa.backupCodesSaveTxt': '另存为 .txt',
  'settings.mfa.backupCodesFileHeader': 'TREK — 双因素认证备用验证码\n每个验证码仅可使用一次。请妥善保存此文件。',
  'settings.mfa.backupCodesPrintFooter': 'TREK — 每个验证码仅可使用一次。请妥善保管打印件。',
  'settings.mfa.backupCodesPrintBlocked': '无法打开打印窗口。请允许此网站的弹出窗口。',
  'settings.mfa.backupCodesSavedTxt': '已开始下载',
  'settings.mfa.backupCodesClose': '我已保存',
  'settings.mfa.backupCodesRemaining': '剩余备用验证码：{count}',
  'settings.mfa.backupCodesNone': '没有备用验证码。若丢失身份验证器，请在下方重新生成。',
  'settings.mfa.regenerateBackupTitle': '备用验证码',
  'settings.mfa.regenerateBackupHint': '输入密码和当前 6 位验证码。旧的备用验证码将失效。',
  'settings.mfa.regenerateBackup': '生成新的备用验证码',
  'settings.mfa.toastBackupRegenerated': '已生成新的备用验证码',
  ...
  'login.mfaSubtitle': '请输入 6 位验证码或一次性备用验证码。',
  'login.mfaCodeLabel': '验证码',
  'login.mfaCodeRequired': '请输入身份验证器验证码或备用验证码。',
  'login.mfaHint': '使用身份验证器应用；若无法访问，可使用备用验证码。',
  'login.mfaBack': '← 返回登录',
  'login.mfaVerify': '验证',

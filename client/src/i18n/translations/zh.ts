const zh: Record<string, string> = {
  ...
  'settings.roadtrip.title': '自驾游',
  'settings.roadtrip.unitSystem': '单位制',
  'settings.roadtrip.metric': '公制',
  'settings.roadtrip.imperial': '英制',
  'settings.roadtrip.vehicle': '车辆',
  'settings.roadtrip.fuelPricePerLitre': '油价（每升）',
  'settings.roadtrip.fuelPricePerGallon': '油价（每加仑）',
  'settings.roadtrip.fuelCurrency': '燃油货币',
  'settings.roadtrip.fuelConsumptionMetric': '油耗（升/100公里）',
  'settings.roadtrip.fuelConsumptionImperial': '油耗（英里/加仑）',
  'settings.roadtrip.tankSizeLitres': '油箱容量（升）',
  'settings.roadtrip.tankSizeGallons': '油箱容量（加仑）',
  'settings.roadtrip.drivingPreferences': '驾驶偏好',
  'settings.roadtrip.maxDrivingHours': '最大驾驶时长',
  'settings.roadtrip.restInterval': '休息间隔（小时）',
  'settings.roadtrip.restDuration': '休息时长（分钟）',
  'settings.roadtrip.maxSpeed': '最高速度',
  'settings.roadtrip.maxSpeedHelp': '限制高速路段的预计行驶时间。留空则使用道路限速。',
  'settings.roadtrip.routePreferences': '路线偏好',
  'settings.roadtrip.daylightOnly': '仅白天行驶',
  'settings.roadtrip.roadPreference': '道路偏好',
  'settings.roadtrip.anyRoad': '任意道路',
  'settings.roadtrip.sealedOnly': '仅铺装路面',
  'settings.roadtrip.fuelPreferences': '燃油偏好',
  'settings.roadtrip.fuelType': '燃油类型',
  'settings.roadtrip.fuelBrand': '品牌偏好',
  'settings.roadtrip.fuelTypeAny': '任何燃油',
  'settings.roadtrip.fuelTypeDiesel': '柴油',
  'settings.roadtrip.fuelTypePetrol': '汽油',
  'settings.roadtrip.brandAny': '任何品牌',
  'settings.roadtrip.brandPreferred': '首选品牌 — 需要时仍显示其他品牌',
  'settings.roadtrip.avoidFerries': '避开渡轮',
  'settings.roadtrip.preferHighways': '优先走高速',
  'settings.roadtrip.truckSafe': '适合卡车/房车',
  'roadtrip.legActive': '自驾游路线已激活',
  'roadtrip.markLeg': '标记为自驾游路段',
  'roadtrip.toggleAll': '切换所有自驾游路段',
  'roadtrip.summary': '自驾游摘要',
  'roadtrip.totalDistance': '总距离',
  'roadtrip.totalTime': '行驶时间',
  'roadtrip.totalFuel': '燃油费用',
  'roadtrip.day': '天',
  'roadtrip.distance': '距离',
  'roadtrip.driveTime': '行驶时间',
  'roadtrip.fuelCost': '燃油',
  'roadtrip.recalculateFuel': '重新计算燃油费用',
  'roadtrip.recalculate': '重新计算',
  'roadtrip.speedAdjusted': '行驶时间已按最高速度 {speed} 调整',
  'roadtrip.rangeWarning': '此路段（{distance}）超出车辆续航里程（{range}），需要加油。',
  'roadtrip.fuelStopsEstimate': '预计加油次数：{count}',
  'roadtrip.exceedsRange': '超出车辆续航里程',
  'roadtrip.refuelPoint': '大约加油点',
  'roadtrip.drivingTimeWarning': '行驶时间（{actual}）超出您每日 {limit} 的限制',
  'roadtrip.restBreaks': '{count} 次休息（+{minutes} 分钟）',
  'roadtrip.restStop': '建议休息站',
  'roadtrip.totalWithBreaks': '含休息总计',
  'roadtrip.daylightWindow': '{sunrise} – {sunset}（{hours}小时）',
  'roadtrip.daylightWarning': '行驶时间（{driving}）超出白天时长（{daylight}）',
  'roadtrip.daylightMode': '白天行驶模式已启用',
  'roadtrip.truckSafeHelp': '需要自建路由服务器并配置卡车模式。默认服务器使用标准汽车路由。',
  'roadtrip.sealedOnlyHelp': '需要自定义路由模式。默认服务器可能包含非铺装道路。',
  'roadtrip.exceedsDaylight': '超出可用白天时长',
  'roadtrip.estimatedRange': '预计续航：{range}',
  'roadtrip.driving': '驾驶',
  'roadtrip.pdfDrivingSummary': '驾驶摘要',
  'roadtrip.pdfTripTotal': '行程总计',
  'roadtrip.toggleAllTrip': '切换所有自驾游路段',
  'roadtrip.calculatingRoutes': '正在计算路线…',
  'roadtrip.showFullRoute': '显示完整行程路线',
  'roadtrip.directions': '导航指引',
  'roadtrip.directionsOmitted': '超过800公里的路段已省略导航指引',
  'roadtrip.directionCount': '{count} 条指引',
  'roadtrip.arrive': '到达目的地',
  'roadtrip.depart': '出发',
  'roadtrip.findStops': '查找停靠点',
  'roadtrip.stopsFound': '找到 {count} 个停靠点',
  'roadtrip.stopSource': '停靠点数据来源',
  'roadtrip.stopSourceOsm': 'OpenStreetMap（免费）',
  'roadtrip.stopSourceGoogle': 'Google Places（更丰富的数据）',
  'roadtrip.stopSourceHelp': '沿路线搜索加油站和休息区的数据来源。',
  'roadtrip.stopSourceGoogleDisabled': 'Google Places 需要管理员配置的 Google Maps API 密钥。',
  'roadtrip.realFuelStop': '加油站',
  'roadtrip.realRestStop': '休息区',
  'roadtrip.openInMaps': '在 Google Maps 中打开',
  'roadtrip.approximateStop': '大致停靠点',
  'roadtrip.refreshStops': '刷新',
  'roadtrip.findingStops': '正在查找停靠点…',
  'roadtrip.recommendedDeparture': '出发时间不早于',
  'roadtrip.arrivalBefore': '到达时间不晚于',
  'roadtrip.drivingWindow': '行驶时间窗口',
  'roadtrip.departBy': '{time} 出发 · {arrival} 到达',
  'roadtrip.insufficientDaylight': '日照时间不足以完成此行程。建议分两天行驶。',
  'roadtrip.setCheckout': '设置退房时间',
  'roadtrip.setCheckin': '设置入住时间',
  'roadtrip.checkoutUpdated': '退房时间已更新',
  'roadtrip.checkinUpdated': '入住时间已更新',
  'roadtrip.daylightOk': '日间驾驶正常',
  'roadtrip.bookingsSafe': '您的退房时间 ({checkout}) 和入住时间 ({checkin}) 在安全日光窗口内',
  'roadtrip.checkoutTooEarly': '退房时间 ({time}) 早于安全出发时间 ({safe})',
  'roadtrip.checkinTooLate': '入住时间 ({time}) 晚于安全到达时间 ({safe})',
  'roadtrip.criticalFuelStop': '必须加油',
  'roadtrip.optionalFuelStop': '可用',
  'roadtrip.mustRefuel': '加油',
  'roadtrip.fuelAvailable': '可用',
  'roadtrip.tripFuelPrice': '燃油价格',
  'roadtrip.tripFuelPriceHelp': '设置此行程的燃油价格',
  'roadtrip.tripOverride': '行程价格',
  'roadtrip.noPreferredBrand': '未找到首选品牌加油站',
  'settings.roadtrip.stopSource': '停靠点搜索',
  ...
  'atlas.roadTrips': '自驾游',
  'atlas.totalDriven': '总行驶距离',
  'atlas.totalRoadTrips': '自驾游',
  'atlas.totalDrivingTime': '驾驶时间',
  'atlas.totalFuelSpent': '燃油费用',
  'atlas.longestTrip': '最长旅程',
  'atlas.longestDay': '最长一天',
  'atlas.tripLegend': '旅程',
  'atlas.viewTrip': '查看旅程',
  'atlas.noRoadTrips': '暂无自驾游数据。在旅行计划中将路段标记为自驾游即可在此查看。',
  'atlas.statsTab': '统计',
  'atlas.bucketTab': '心愿单',

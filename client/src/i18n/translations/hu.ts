const hu: Record<string, string | { name: string; category: string }[]> = {
  ...
  'packing.type.shared': 'megosztott',
  'packing.type.personal': 'személyes',
  'packing.type.private': 'privát',
  'packing.type.shared.hint': 'Mindenki számára látható. A kipipálások közösek.',
  'packing.type.personal.hint': 'Mindenki számára látható, de mindenki a saját kipipálásait kezeli.',
  'packing.type.private.hint': 'Csak te látod ezt a kategóriát és az elemeit.',
  'packing.type.makeShared': 'Megosztottá tétel',
  'packing.type.makePersonal': 'Személyessé tétel',
  'packing.type.makePrivate': 'Priváttá tétel',
  'packing.categoryExists': 'A kategória már létezik',
  ...
  'packing.saveAsTemplate.hint': 'A privát kategóriák nem szerepelnek benne.',

const hu: Record<string, string | { name: string; category: string }[]> = {
  ...
  'settings.roadtrip.title': 'Autós túra',
  'settings.roadtrip.unitSystem': 'Mértékegység-rendszer',
  'settings.roadtrip.metric': 'Metrikus',
  'settings.roadtrip.imperial': 'Angolszász',
  'settings.roadtrip.vehicle': 'Jármű',
  'settings.roadtrip.fuelPricePerLitre': 'Üzemanyagár (literenként)',
  'settings.roadtrip.fuelPricePerGallon': 'Üzemanyagár (gallononként)',
  'settings.roadtrip.fuelCurrency': 'Üzemanyag pénzneme',
  'settings.roadtrip.fuelConsumptionMetric': 'Üzemanyag-fogyasztás (L/100km)',
  'settings.roadtrip.fuelConsumptionImperial': 'Üzemanyag-hatékonyság (MPG)',
  'settings.roadtrip.tankSizeLitres': 'Üzemanyagtank mérete (liter)',
  'settings.roadtrip.tankSizeGallons': 'Üzemanyagtank mérete (gallon)',
  'settings.roadtrip.drivingPreferences': 'Vezetési beállítások',
  'settings.roadtrip.maxDrivingHours': 'Maximális vezetési idő',
  'settings.roadtrip.restInterval': 'Pihenő időköze (óra)',
  'settings.roadtrip.restDuration': 'Pihenő hossza (perc)',
  'settings.roadtrip.maxSpeed': 'Maximális sebesség',
  'settings.roadtrip.maxSpeedHelp': 'Korlátozza a becsült menetidőt a magasabb sebességkorlátozású utakon. Hagyja üresen a kiírt sebességhatárok használatához.',
  'settings.roadtrip.routePreferences': 'Útvonal-beállítások',
  'settings.roadtrip.daylightOnly': 'Csak nappali vezetés',
  'settings.roadtrip.roadPreference': 'Útpreferencia',
  'settings.roadtrip.anyRoad': 'Bármilyen út',
  'settings.roadtrip.sealedOnly': 'Csak burkolt út',
  'settings.roadtrip.fuelPreferences': 'Üzemanyag beállítások',
  'settings.roadtrip.fuelType': 'Üzemanyag típus',
  'settings.roadtrip.fuelBrand': 'Kedvelt márka',
  'settings.roadtrip.fuelTypeAny': 'Bármely üzemanyag',
  'settings.roadtrip.fuelTypeDiesel': 'Dízel',
  'settings.roadtrip.fuelTypePetrol': 'Benzin',
  'settings.roadtrip.brandAny': 'Bármely márka',
  'settings.roadtrip.brandPreferred': 'Kedvelt márka — más márkák is megjelennek szükség esetén',
  'settings.roadtrip.avoidFerries': 'Kompok elkerülése',
  'settings.roadtrip.preferHighways': 'Autópályák előnyben',
  'settings.roadtrip.truckSafe': 'Tehergépjármű / lakóautó biztos',
  'roadtrip.legActive': 'Autós túra útvonal aktív',
  'roadtrip.markLeg': 'Megjelölés autós túra szakaszként',
  'roadtrip.toggleAll': 'Összes autós túra szakasz váltása',
  'roadtrip.summary': 'Autós túra összefoglalója',
  'roadtrip.totalDistance': 'Össztávolság',
  'roadtrip.totalTime': 'Vezetési idő',
  'roadtrip.totalFuel': 'Üzemanyagköltség',
  'roadtrip.day': 'Nap',
  'roadtrip.distance': 'Távolság',
  'roadtrip.driveTime': 'Vezetési idő',
  'roadtrip.fuelCost': 'Üzemanyag',
  'roadtrip.recalculateFuel': 'Üzemanyagköltségek újraszámítása',
  'roadtrip.recalculate': 'Újraszámítás',
  'roadtrip.speedAdjusted': 'Menetidők {speed} maximális sebességhez igazítva',
  'roadtrip.rangeWarning': 'Ez a szakasz ({distance}) meghaladja a jármű hatótávolságát ({range}). Tankolás szükséges.',
  'roadtrip.fuelStopsEstimate': 'Becsült tankolási megállók: {count}',
  'roadtrip.exceedsRange': 'Meghaladja a jármű hatótávolságát',
  'roadtrip.refuelPoint': 'Hozzávetőleges tankolási pont',
  'roadtrip.drivingTimeWarning': 'A vezetési idő ({actual}) meghaladja a napi {limit} korlátot',
  'roadtrip.restBreaks': '{count} pihenő (+{minutes} perc)',
  'roadtrip.restStop': 'Javasolt pihenő',
  'roadtrip.totalWithBreaks': 'Összesen pihenőkkel',
  'roadtrip.daylightWindow': '{sunrise} – {sunset} ({hours} óra)',
  'roadtrip.daylightWarning': 'A vezetési idő ({driving}) meghaladja a nappali órákat ({daylight})',
  'roadtrip.daylightMode': 'Nappali vezetési mód aktív',
  'roadtrip.truckSafeHelp': 'Saját üzemeltetésű útválasztó szerver szükséges tehergépjármű profillal. Az alapértelmezett szerver hagyományos személyautó útvonalat használ.',
  'roadtrip.sealedOnlyHelp': 'Egyéni útvonalprofil szükséges. Az alapértelmezett szerver tartalmazhat burkolatlan utakat.',
  'roadtrip.exceedsDaylight': 'Meghaladja a rendelkezésre álló nappali órákat',
  'roadtrip.estimatedRange': 'Becsült hatótávolság: {range}',
  'roadtrip.driving': 'Vezetés',
  'roadtrip.pdfDrivingSummary': 'Vezetési összefoglaló',
  'roadtrip.pdfTripTotal': 'Túra összesen',
  'roadtrip.toggleAllTrip': 'Összes autós túra szakasz váltása',
  'roadtrip.calculatingRoutes': 'Útvonalak számítása…',
  'roadtrip.showFullRoute': 'Teljes útvonal megjelenítése',
  'roadtrip.directions': 'Útvonalterv',
  'roadtrip.directionsOmitted': 'Útvonalterv kihagyva 800 km feletti szakaszokhoz',
  'roadtrip.directionCount': '{count} utasítás',
  'roadtrip.arrive': 'Megérkezés a célhoz',
  'roadtrip.depart': 'Indulás',
  'roadtrip.findStops': 'Megállók keresése',
  'roadtrip.stopsFound': '{count} megálló találva',
  'roadtrip.stopSource': 'Megálló adatforrás',
  'roadtrip.stopSourceOsm': 'OpenStreetMap (ingyenes)',
  'roadtrip.stopSourceGoogle': 'Google Places (gazdagabb adatok)',
  'roadtrip.stopSourceHelp': 'Forrás benzinkutak és pihenőhelyek kereséséhez az útvonal mentén.',
  'roadtrip.stopSourceGoogleDisabled': 'A Google Places használatához az adminisztrátornak konfigurált Google Maps API kulcs szükséges.',
  'roadtrip.realFuelStop': 'benzinkút',
  'roadtrip.realRestStop': 'pihenő',
  'roadtrip.openInMaps': 'Megnyitás Google Maps-ben',
  'roadtrip.approximateStop': 'Hozzávetőleges megálló',
  'roadtrip.refreshStops': 'Frissítés',
  'roadtrip.findingStops': 'Megállók keresése…',
  'roadtrip.recommendedDeparture': 'Indulás után',
  'roadtrip.arrivalBefore': 'Érkezés előtt',
  'roadtrip.drivingWindow': 'Vezetési időablak',
  'roadtrip.departBy': 'Indulás: {time} · Érkezés: {arrival}',
  'roadtrip.insufficientDaylight': 'Nincs elég nappali fény ehhez az úthoz. Fontolja meg a két napra való felosztást.',
  'roadtrip.setCheckout': 'Kijelentkezés beállítása',
  'roadtrip.setCheckin': 'Bejelentkezés beállítása',
  'roadtrip.checkoutUpdated': 'Kijelentkezési idő frissítve',
  'roadtrip.checkinUpdated': 'Bejelentkezési idő frissítve',
  'roadtrip.daylightOk': 'Nappali vezetés OK',
  'roadtrip.bookingsSafe': 'A check-out ({checkout}) és check-in ({checkin}) a biztonságos nappali időablakon belül van',
  'roadtrip.checkoutTooEarly': 'Check-out ({time}) a biztonságos indulás előtt van ({safe})',
  'roadtrip.checkinTooLate': 'Check-in ({time}) a biztonságos érkezés után van ({safe})',
  'roadtrip.criticalFuelStop': 'Tankolás szükséges',
  'roadtrip.optionalFuelStop': 'Elérhető',
  'roadtrip.mustRefuel': 'TANKOLÁS',
  'roadtrip.fuelAvailable': 'Elérhető',
  'roadtrip.tripFuelPrice': 'Üzemanyag ár',
  'roadtrip.tripFuelPriceHelp': 'Üzemanyag ár ehhez az úthoz',
  'roadtrip.tripOverride': 'egyedi ár',
  'roadtrip.noPreferredBrand': 'Nem található kedvelt márkájú állomás',
  'settings.roadtrip.stopSource': 'Megálló keresés',
  ...
  'atlas.roadTrips': 'Autós utak',
  'atlas.totalDriven': 'Összes megtett út',
  'atlas.totalRoadTrips': 'Autós utak',
  'atlas.totalDrivingTime': 'Vezetési idő',
  'atlas.totalFuelSpent': 'Üzemanyag költség',
  'atlas.longestTrip': 'Leghosszabb út',
  'atlas.longestDay': 'Leghosszabb nap',
  'atlas.tripLegend': 'Utak',
  'atlas.viewTrip': 'Út megtekintése',
  'atlas.noRoadTrips': 'Még nincsenek autós út adatok. Jelöljön meg szakaszokat autós útként az útitervekben, hogy itt lássa őket.',

const en: Record<string, string | { name: string; category: string }[]> = {
  ...
  'reservations.arrivalDate': 'Arrival date',
  'reservations.arrivalDay': 'Arrival day',
  'reservations.arrivalTime': 'Arrival time',
  ...
  'reservations.fillManually': 'Fill manually instead',
  'reservations.backToSearch': 'Back to flight search',
  'reservations.flightFound': 'Flight data populated!',
  'reservations.flightNotFound': 'Flight not found.',

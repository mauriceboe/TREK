const en: Record<string, string | { name: string; category: string }[]> = {
  ...
  'packing.type.shared': 'shared',
  'packing.type.personal': 'personal',
  'packing.type.private': 'private',
  'packing.type.shared.hint': 'Visible to everyone. Checks are shared.',
  'packing.type.personal.hint': 'Visible to everyone, but each person tracks their own checks.',
  'packing.type.private.hint': 'Only you can see this category and its items.',
  'packing.type.makeShared': 'Make shared',
  'packing.type.makePersonal': 'Make personal',
  'packing.type.makePrivate': 'Make private',
  'packing.categoryExists': 'Category already exists',
  ...
  'packing.saveAsTemplate.hint': 'Private categories aren\'t included.',

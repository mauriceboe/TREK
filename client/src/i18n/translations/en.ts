const en: Record<string, string | { name: string; category: string }[]> = {
  ...
  'settings.mfa.backupCodesTitle': 'Save your backup codes',
  'settings.mfa.backupCodesIntro': 'These are one-time codes you can use to sign in if you lose your authenticator. Each code works only once.',
  'settings.mfa.backupCodesWarning': 'Store them in a safe place. This is the only time we show them unless you generate new ones.',
  'settings.mfa.backupCodesCopyAll': 'Copy all',
  'settings.mfa.backupCodesCopied': 'Copied to clipboard',
  'settings.mfa.backupCodesPrint': 'Print / Save as PDF',
  'settings.mfa.backupCodesSaveTxt': 'Save as .txt',
  'settings.mfa.backupCodesFileHeader': 'TREK — Two-factor authentication backup codes\nEach code works once. Store this file securely.',
  'settings.mfa.backupCodesPrintFooter': 'TREK — Each code is single-use. Keep this printout safe.',
  'settings.mfa.backupCodesPrintBlocked': 'Could not open the print window. Allow pop-ups for this site.',
  'settings.mfa.backupCodesSavedTxt': 'Download started',
  'settings.mfa.backupCodesClose': 'I have saved them',
  'settings.mfa.backupCodesRemaining': '{count} backup codes remaining',
  'settings.mfa.backupCodesNone': 'No backup codes left. Generate new codes below if you lose your authenticator.',
  'settings.mfa.regenerateBackupTitle': 'Backup codes',
  'settings.mfa.regenerateBackupHint': 'Enter your password and a current 6-digit code from your authenticator. Any previous backup codes will stop working.',
  'settings.mfa.regenerateBackup': 'Generate new backup codes',
  'settings.mfa.toastBackupRegenerated': 'New backup codes generated',
  ...
  'login.mfaSubtitle': 'Enter the 6-digit code from your authenticator, or a one-time backup code.',
  'login.mfaCodeLabel': 'Verification code',
  'login.mfaCodeRequired': 'Enter your authenticator code or a backup code.',
  'login.mfaHint': 'Use your authenticator app, or a backup code if you lost access.',

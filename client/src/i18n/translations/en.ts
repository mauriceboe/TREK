const en: Record<string, string | { name: string; category: string }[]> = {
  ...
  'admin.update.dataInfo': 'All your data (trips, users, API keys, uploads, Vacay, Atlas, budgets, costs) will be preserved.',
  ...
  // Kosten addon
  'trip.tabs.kosten': 'Costs',
  'kosten.subtitle': 'Split expenses and settle up',
  'kosten.addExpense': 'Add expense',
  'kosten.editExpense': 'Edit expense',
  'kosten.deleteExpenseConfirm': 'Delete this expense?',
  'kosten.tabExpenses': 'Expenses',
  'kosten.tabSettlement': 'Settlement',
  'kosten.expenseTitle': 'Title',
  'kosten.amount': 'Amount',
  'kosten.currency': 'Currency',
  'kosten.exchangeRate': 'Exchange rate',
  'kosten.exchangeRateHint': '1 {from} = {rate} {to}',
  'kosten.fetchRate': 'Fetch rate',
  'kosten.convertedAmount': '≈ {amount} {currency}',
  'kosten.paidBy': 'Paid by',
  'kosten.category': 'Category',
  'kosten.date': 'Date',
  'kosten.note': 'Note',
  'kosten.splitType': 'Split',
  'kosten.splitEqual': 'Equal',
  'kosten.splitAmount': 'By amount',
  'kosten.splitPercent': 'By percent',
  'kosten.participants': 'Participants',
  'kosten.perPerson': 'per person',
  'kosten.totalSpent': 'Total spent',
  'kosten.noExpenses': 'No expenses yet',
  'kosten.noExpensesHint': 'Add the first expense',
  'kosten.balances': 'Balances',
  'kosten.allSettled': 'All settled!',
  'kosten.allSettledHint': 'No outstanding debts',
  'kosten.simplifiedDebts': 'Simplified debts',
  'kosten.owes': 'owes',
  'kosten.settleUp': 'Record settlement',
  'kosten.settlements': 'Settlements',
  'kosten.addSettlement': 'Add settlement',
  'kosten.fromUser': 'From',
  'kosten.toUser': 'To',
  'kosten.deleteSettlementConfirm': 'Delete this settlement?',
  'kosten.pdfExport': 'PDF',
  'kosten.pdfTitle': 'Expense report',
  'kosten.perPersonTitle': 'Per person',
  'kosten.cat.accommodation': 'Accommodation',
  'kosten.cat.transport': 'Transport',
  'kosten.cat.food': 'Food & Drinks',
  'kosten.cat.activities': 'Activities',
  'kosten.cat.shopping': 'Shopping',
  'kosten.cat.other': 'Other',
  'kosten.addCategory': '+ Category',
  'kosten.newCategoryPlaceholder': 'New category…',
  'kosten.addPayer': '+ Payer',
  'kosten.newPayerPlaceholder': 'Payer name…',

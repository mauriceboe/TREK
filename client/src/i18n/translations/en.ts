const en: Record<string, string | { name: string; category: string }[]> = {
  ...
  'settings.roadtrip.unitSystem': 'Unit System',
  'settings.roadtrip.metric': 'Metric',
  'settings.roadtrip.imperial': 'Imperial',
  'settings.roadtrip.vehicle': 'Vehicle',
  'settings.roadtrip.fuelPricePerLitre': 'Fuel price (per litre)',
  'settings.roadtrip.fuelPricePerGallon': 'Fuel price (per gallon)',
  'settings.roadtrip.fuelCurrency': 'Fuel currency',
  'settings.roadtrip.fuelConsumptionMetric': 'Fuel consumption (L/100km)',
  'settings.roadtrip.fuelConsumptionImperial': 'Fuel economy (MPG)',
  'settings.roadtrip.tankSizeLitres': 'Fuel tank size (litres)',
  'settings.roadtrip.tankSizeGallons': 'Fuel tank size (gallons)',
  'settings.roadtrip.drivingPreferences': 'Driving Preferences',
  'settings.roadtrip.maxDrivingHours': 'Max driving hours',
  'settings.roadtrip.restInterval': 'Rest interval (hours)',
  'settings.roadtrip.restDuration': 'Rest duration (minutes)',
  'settings.roadtrip.maxSpeed': 'Maximum speed',
  'settings.roadtrip.maxSpeedHelp': 'Limits estimated drive times on roads with higher speed limits. Leave empty to use posted speed limits.',
  'settings.roadtrip.routePreferences': 'Route Preferences',
  'settings.roadtrip.daylightOnly': 'Daylight driving only',
  'settings.roadtrip.roadPreference': 'Road preference',
  'settings.roadtrip.anyRoad': 'Any road',
  'settings.roadtrip.sealedOnly': 'Sealed only',
  'settings.roadtrip.fuelPreferences': 'Fuel Preferences',
  'settings.roadtrip.fuelType': 'Fuel type',
  'settings.roadtrip.fuelBrand': 'Brand preference',
  'settings.roadtrip.fuelTypeAny': 'Any fuel',
  'settings.roadtrip.fuelTypeDiesel': 'Diesel',
  'settings.roadtrip.fuelTypePetrol': 'Petrol',
  'settings.roadtrip.brandAny': 'Any brand',
  'settings.roadtrip.brandPreferred': 'Preferred brand — others still shown if needed',
  'settings.roadtrip.avoidFerries': 'Avoid ferries',
  'settings.roadtrip.preferHighways': 'Prefer highways',
  'settings.roadtrip.truckSafe': 'Truck / RV safe',
  'roadtrip.legActive': 'Road trip route active',
  'roadtrip.markLeg': 'Mark as road trip leg',
  'roadtrip.toggleAll': 'Toggle all road trip legs',
  'roadtrip.summary': 'Road Trip Summary',
  'roadtrip.totalDistance': 'Total distance',
  'roadtrip.totalTime': 'Drive time',
  'roadtrip.totalFuel': 'Fuel cost',
  'roadtrip.day': 'Day',
  'roadtrip.distance': 'Distance',
  'roadtrip.driveTime': 'Drive time',
  'roadtrip.fuelCost': 'Fuel',
  'roadtrip.recalculateFuel': 'Recalculate fuel costs',
  'roadtrip.recalculate': 'Recalculate',
  'roadtrip.speedAdjusted': 'Drive times adjusted for {speed} max speed',
  'roadtrip.rangeWarning': 'This leg ({distance}) exceeds your vehicle range ({range}). Refuelling will be needed.',
  'roadtrip.fuelStopsEstimate': 'Estimated fuel stops: {count}',
  'roadtrip.exceedsRange': 'Exceeds vehicle range',
  'roadtrip.refuelPoint': 'Approximate refuel point',
  'roadtrip.drivingTimeWarning': 'Driving time ({actual}) exceeds your {limit} daily limit',
  'roadtrip.restBreaks': '{count} rest breaks (+{minutes} min)',
  'roadtrip.restStop': 'Recommended rest stop',
  'roadtrip.totalWithBreaks': 'Total with breaks',
  'roadtrip.daylightWindow': '{sunrise} – {sunset} ({hours}h)',
  'roadtrip.daylightWarning': 'Driving ({driving}) exceeds daylight ({daylight})',
  'roadtrip.daylightMode': 'Daylight driving mode active',
  'roadtrip.truckSafeHelp': 'Requires a self-hosted routing server with truck profile. Default server uses standard car routing.',
  'roadtrip.sealedOnlyHelp': 'Requires a custom routing profile. Default server may include unsealed roads.',
  'roadtrip.exceedsDaylight': 'Exceeds available daylight hours',
  'roadtrip.estimatedRange': 'Estimated range: {range}',
  'roadtrip.driving': 'Driving',
  'roadtrip.pdfDrivingSummary': 'Driving Summary',
  'roadtrip.pdfTripTotal': 'Trip Total',
  'roadtrip.toggleAllTrip': 'Toggle all road trip legs',
  'roadtrip.calculatingRoutes': 'Calculating routes…',
  'roadtrip.showFullRoute': 'Show full trip route',
  'roadtrip.directions': 'Directions',
  'roadtrip.directionsOmitted': 'Directions omitted for legs over 800 km',
  'roadtrip.directionCount': '{count} directions',
  'roadtrip.arrive': 'Arrive at destination',
  'roadtrip.depart': 'Depart',
  'roadtrip.findStops': 'Find stops',
  'roadtrip.stopsFound': '{count} stops found',
  'roadtrip.stopSource': 'Stop data source',
  'roadtrip.stopSourceOsm': 'OpenStreetMap (free)',
  'roadtrip.stopSourceGoogle': 'Google Places (richer data)',
  'roadtrip.stopSourceHelp': 'Source for fuel station and rest area lookups along routes.',
  'roadtrip.stopSourceGoogleDisabled': 'Google Places requires a Google Maps API key configured by the administrator.',
  'roadtrip.realFuelStop': 'fuel',
  'roadtrip.realRestStop': 'rest',
  'roadtrip.openInMaps': 'Open in Google Maps',
  'roadtrip.approximateStop': 'Approximate stop',
  'roadtrip.refreshStops': 'Refresh',
  'roadtrip.findingStops': 'Finding stops…',
  'roadtrip.recommendedDeparture': 'Depart after',
  'roadtrip.arrivalBefore': 'Arrive before',
  'roadtrip.drivingWindow': 'Driving window',
  'roadtrip.departBy': 'Depart by {time} · Arrive by {arrival}',
  'roadtrip.insufficientDaylight': 'Not enough daylight for this drive. Consider splitting across two days.',
  'roadtrip.setCheckout': 'Set check-out',
  'roadtrip.setCheckin': 'Set check-in',
  'roadtrip.checkoutUpdated': 'Check-out time updated',
  'roadtrip.checkinUpdated': 'Check-in time updated',
  'roadtrip.daylightOk': 'Daylight driving OK',
  'roadtrip.bookingsSafe': 'Your check-out ({checkout}) and check-in ({checkin}) are within the safe daylight window',
  'roadtrip.checkoutTooEarly': 'Check-out ({time}) is before safe departure ({safe})',
  'roadtrip.checkinTooLate': 'Check-in ({time}) is after safe arrival ({safe})',
  'roadtrip.criticalFuelStop': 'Must refuel',
  'roadtrip.optionalFuelStop': 'Available',
  'roadtrip.mustRefuel': 'REFUEL',
  'roadtrip.fuelAvailable': 'Available',
  'roadtrip.tripFuelPrice': 'Fuel price',
  'roadtrip.tripFuelPriceHelp': 'Set a fuel price specific to this trip',
  'roadtrip.tripOverride': 'trip override',
  'roadtrip.noPreferredBrand': 'No preferred brand stations found, showing all',
  'settings.roadtrip.stopSource': 'Stop Search',
  ...
  'atlas.totalDriven': 'Total driven',
  'atlas.totalRoadTrips': 'Road trips',
  'atlas.totalDrivingTime': 'Drive time',
  'atlas.totalFuelSpent': 'Fuel spent',
  'atlas.longestTrip': 'Longest trip',
  'atlas.longestDay': 'Longest day',
  'atlas.tripLegend': 'Trips',
  'atlas.viewTrip': 'View trip',
  'atlas.noRoadTrips': 'No road trip data yet. Mark legs as road trips in your trip plans to see them here.',

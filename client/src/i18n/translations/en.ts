const en: Record<string, string | { name: string; category: string }[]> = {
  ...
  'admin.mcpTokens.usageTab': 'Usage',
  'admin.mcpTokens.tokensTab': 'Tokens',
  'admin.mcpTokens.usage.title': 'MCP Token Usage',
  'admin.mcpTokens.usage.subtitle': 'Request volume across all MCP API tokens',
  'admin.mcpTokens.usage.hourlyChart': 'Requests — Last 24 Hours',
  'admin.mcpTokens.usage.dailyChart': 'Requests — Last 30 Days',
  'admin.mcpTokens.usage.byToken': 'Per-Token Breakdown',
  'admin.mcpTokens.usage.last24h': '24h',
  'admin.mcpTokens.usage.last30d': '30d',
  'admin.mcpTokens.usage.noData': 'No usage data yet',
  'admin.mcpTokens.usage.loadError': 'Failed to load usage data',
  'admin.mcpTokens.usage.requests': 'requests',
  'admin.mcpTokens.usage.config': 'Active Configuration',
  'admin.mcpTokens.usage.rateLimitMax': 'Rate limit',
  'admin.mcpTokens.usage.rateLimitUnit': 'req / min / user',
  'admin.mcpTokens.usage.maxSessions': 'Max concurrent sessions',
  'admin.mcpTokens.usage.sessionsUnit': 'sessions / user',
  'admin.mcpTokens.usage.sessionTtl': 'Session timeout',
  'admin.mcpTokens.usage.sessionTtlUnit': 'min inactivity',
  'admin.mcpTokens.usage.envHint': 'Override with MCP_RATE_LIMIT env var',

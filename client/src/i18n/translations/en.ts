const en: Record<string, string | { name: string; category: string }[]> = {
  ...
  'dashboard.copyTrip': 'Duplicate',
  'dashboard.toast.copied': 'Trip duplicated successfully',
  'dashboard.toast.copyError': 'Failed to duplicate trip',
  ...
  'admin.sessions.subtitle': 'Currently active user sessions with device and IP information.',
  'admin.sessions.empty': 'No active sessions.',
  'admin.sessions.col.user': 'User',
  'admin.sessions.col.ip': 'IP Address',
  'admin.sessions.col.device': 'Device',
  'admin.sessions.col.lastActive': 'Last Active',
  ...
  'reservations.budgetCategoryAuto': 'Auto (from type)',
  'reservations.budgetHint': 'A budget entry will be auto-created for this reservation.',

const it: Record<string, string | { name: string; category: string }[]> = {
  ...
  'settings.roadtrip.title': 'Viaggio in auto',
  'settings.roadtrip.unitSystem': 'Sistema di unità',
  'settings.roadtrip.metric': 'Metrico',
  'settings.roadtrip.imperial': 'Imperiale',
  'settings.roadtrip.vehicle': 'Veicolo',
  'settings.roadtrip.fuelPricePerLitre': 'Prezzo carburante (al litro)',
  'settings.roadtrip.fuelPricePerGallon': 'Prezzo carburante (al gallone)',
  'settings.roadtrip.fuelCurrency': 'Valuta carburante',
  'settings.roadtrip.fuelConsumptionMetric': 'Consumo carburante (L/100km)',
  'settings.roadtrip.fuelConsumptionImperial': 'Efficienza carburante (MPG)',
  'settings.roadtrip.tankSizeLitres': 'Capacità serbatoio (litri)',
  'settings.roadtrip.tankSizeGallons': 'Capacità serbatoio (galloni)',
  'settings.roadtrip.drivingPreferences': 'Preferenze di guida',
  'settings.roadtrip.maxDrivingHours': 'Ore di guida massime',
  'settings.roadtrip.restInterval': 'Intervallo di riposo (ore)',
  'settings.roadtrip.restDuration': 'Durata del riposo (minuti)',
  'settings.roadtrip.maxSpeed': 'Velocità massima',
  'settings.roadtrip.maxSpeedHelp': 'Limita i tempi di guida stimati sulle strade con limiti di velocità più alti. Lasciare vuoto per utilizzare i limiti pubblicati.',
  'settings.roadtrip.routePreferences': 'Preferenze di percorso',
  'settings.roadtrip.daylightOnly': 'Guida solo diurna',
  'settings.roadtrip.roadPreference': 'Preferenza stradale',
  'settings.roadtrip.anyRoad': 'Qualsiasi strada',
  'settings.roadtrip.sealedOnly': 'Solo asfaltate',
  'settings.roadtrip.fuelPreferences': 'Preferenze carburante',
  'settings.roadtrip.fuelType': 'Tipo di carburante',
  'settings.roadtrip.fuelBrand': 'Marca preferita',
  'settings.roadtrip.fuelTypeAny': 'Qualsiasi carburante',
  'settings.roadtrip.fuelTypeDiesel': 'Diesel',
  'settings.roadtrip.fuelTypePetrol': 'Benzina',
  'settings.roadtrip.brandAny': 'Qualsiasi marca',
  'settings.roadtrip.brandPreferred': 'Marca preferita — altre mostrate se necessario',
  'settings.roadtrip.avoidFerries': 'Evita traghetti',
  'settings.roadtrip.preferHighways': 'Preferisci autostrade',
  'settings.roadtrip.truckSafe': 'Adatto a camion / camper',
  'roadtrip.legActive': 'Percorso viaggio in auto attivo',
  'roadtrip.markLeg': 'Segna come tappa del viaggio',
  'roadtrip.toggleAll': 'Attiva/disattiva tutte le tappe del viaggio',
  'roadtrip.summary': 'Riepilogo viaggio in auto',
  'roadtrip.totalDistance': 'Distanza totale',
  'roadtrip.totalTime': 'Tempo di guida',
  'roadtrip.totalFuel': 'Costo carburante',
  'roadtrip.day': 'Giorno',
  'roadtrip.distance': 'Distanza',
  'roadtrip.driveTime': 'Tempo di guida',
  'roadtrip.fuelCost': 'Carburante',
  'roadtrip.recalculateFuel': 'Ricalcola costi carburante',
  'roadtrip.recalculate': 'Ricalcola',
  'roadtrip.speedAdjusted': 'Tempi di guida adeguati per velocità massima di {speed}',
  'roadtrip.rangeWarning': 'Questa tappa ({distance}) supera l\'autonomia del veicolo ({range}). Sarà necessario fare rifornimento.',
  'roadtrip.fuelStopsEstimate': 'Soste rifornimento stimate: {count}',
  'roadtrip.exceedsRange': 'Supera l\'autonomia del veicolo',
  'roadtrip.refuelPoint': 'Punto di rifornimento approssimativo',
  'roadtrip.drivingTimeWarning': 'Il tempo di guida ({actual}) supera il limite giornaliero di {limit}',
  'roadtrip.restBreaks': '{count} pause di riposo (+{minutes} min)',
  'roadtrip.restStop': 'Sosta di riposo consigliata',
  'roadtrip.totalWithBreaks': 'Totale con pause',
  'roadtrip.daylightWindow': '{sunrise} – {sunset} ({hours}h)',
  'roadtrip.daylightWarning': 'La guida ({driving}) supera le ore di luce ({daylight})',
  'roadtrip.daylightMode': 'Modalità guida diurna attiva',
  'roadtrip.truckSafeHelp': 'Richiede un server di routing self-hosted con profilo camion. Il server predefinito usa il routing auto standard.',
  'roadtrip.sealedOnlyHelp': 'Richiede un profilo di routing personalizzato. Il server predefinito può includere strade sterrate.',
  'roadtrip.exceedsDaylight': 'Supera le ore di luce disponibili',
  'roadtrip.estimatedRange': 'Autonomia stimata: {range}',
  'roadtrip.driving': 'Guida',
  'roadtrip.pdfDrivingSummary': 'Riepilogo di guida',
  'roadtrip.pdfTripTotal': 'Totale viaggio',
  'roadtrip.toggleAllTrip': 'Attiva/disattiva tutte le tappe del viaggio',
  'roadtrip.calculatingRoutes': 'Calcolo percorsi…',
  'roadtrip.showFullRoute': 'Mostra percorso completo del viaggio',
  'roadtrip.directions': 'Indicazioni',
  'roadtrip.directionsOmitted': 'Indicazioni omesse per tratte oltre 800 km',
  'roadtrip.directionCount': '{count} indicazioni',
  'roadtrip.arrive': 'Arrivo a destinazione',
  'roadtrip.depart': 'Partenza',
  'roadtrip.findStops': 'Cerca soste',
  'roadtrip.stopsFound': '{count} soste trovate',
  'roadtrip.stopSource': 'Fonte dati soste',
  'roadtrip.stopSourceOsm': 'OpenStreetMap (gratuito)',
  'roadtrip.stopSourceGoogle': 'Google Places (dati più ricchi)',
  'roadtrip.stopSourceHelp': 'Fonte per la ricerca di stazioni di servizio e aree di sosta lungo il percorso.',
  'roadtrip.stopSourceGoogleDisabled': 'Google Places richiede una chiave API Google Maps configurata dall\'amministratore.',
  'roadtrip.realFuelStop': 'distributore',
  'roadtrip.realRestStop': 'area di sosta',
  'roadtrip.openInMaps': 'Apri in Google Maps',
  'roadtrip.approximateStop': 'Sosta approssimativa',
  'roadtrip.refreshStops': 'Aggiorna',
  'roadtrip.findingStops': 'Ricerca soste in corso…',
  'roadtrip.recommendedDeparture': 'Partenza dopo',
  'roadtrip.arrivalBefore': 'Arrivo entro',
  'roadtrip.drivingWindow': 'Finestra di guida',
  'roadtrip.departBy': 'Partenza alle {time} · Arrivo alle {arrival}',
  'roadtrip.insufficientDaylight': 'Luce diurna insufficiente per questo viaggio. Considera di suddividerlo in due giorni.',
  'roadtrip.setCheckout': 'Imposta check-out',
  'roadtrip.setCheckin': 'Imposta check-in',
  'roadtrip.checkoutUpdated': 'Orario di check-out aggiornato',
  'roadtrip.checkinUpdated': 'Orario di check-in aggiornato',
  'roadtrip.daylightOk': 'Guida diurna OK',
  'roadtrip.bookingsSafe': 'Il check-out ({checkout}) e il check-in ({checkin}) sono nella finestra sicura di luce diurna',
  'roadtrip.checkoutTooEarly': 'Check-out ({time}) è prima della partenza sicura ({safe})',
  'roadtrip.checkinTooLate': 'Check-in ({time}) è dopo l\'arrivo sicuro ({safe})',
  'roadtrip.criticalFuelStop': 'Rifornimento necessario',
  'roadtrip.optionalFuelStop': 'Disponibile',
  'roadtrip.mustRefuel': 'RIFORNIRE',
  'roadtrip.fuelAvailable': 'Disponibile',
  'roadtrip.tripFuelPrice': 'Prezzo carburante',
  'roadtrip.tripFuelPriceHelp': 'Prezzo carburante specifico per questo viaggio',
  'roadtrip.tripOverride': 'prezzo viaggio',
  'roadtrip.noPreferredBrand': 'Nessuna stazione del marchio preferito trovata',
  'settings.roadtrip.stopSource': 'Ricerca soste',
  ...
  'atlas.roadTrips': 'Viaggi su strada',
  'atlas.totalDriven': 'Totale percorso',
  'atlas.totalRoadTrips': 'Viaggi',
  'atlas.totalDrivingTime': 'Tempo di guida',
  'atlas.totalFuelSpent': 'Spesa carburante',
  'atlas.longestTrip': 'Viaggio più lungo',
  'atlas.longestDay': 'Giornata più lunga',
  'atlas.tripLegend': 'Viaggi',
  'atlas.viewTrip': 'Vedi viaggio',
  'atlas.noRoadTrips': 'Nessun dato sui viaggi su strada. Contrassegna le tappe come viaggi su strada nei tuoi piani per vederli qui.',

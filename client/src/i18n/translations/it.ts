const it: Record<string, string | { name: string; category: string }[]> = {
  ...
  'packing.type.shared': 'condiviso',
  'packing.type.personal': 'personale',
  'packing.type.private': 'privato',
  'packing.type.shared.hint': 'Visibile a tutti. Le spunte sono condivise.',
  'packing.type.personal.hint': 'Visibile a tutti, ma ognuno gestisce le proprie spunte.',
  'packing.type.private.hint': 'Solo tu puoi vedere questa categoria e i suoi elementi.',
  'packing.type.makeShared': 'Rendi condiviso',
  'packing.type.makePersonal': 'Rendi personale',
  'packing.type.makePrivate': 'Rendi privato',
  'packing.categoryExists': 'La categoria esiste già',
  ...
  'packing.saveAsTemplate.hint': 'Le categorie private non vengono incluse.',

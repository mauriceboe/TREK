const ru: Record<string, string> = {
  ...
  'settings.roadtrip.title': 'Автопутешествие',
  'settings.roadtrip.unitSystem': 'Система единиц',
  'settings.roadtrip.metric': 'Метрическая',
  'settings.roadtrip.imperial': 'Имперская',
  'settings.roadtrip.vehicle': 'Транспорт',
  'settings.roadtrip.fuelPricePerLitre': 'Цена топлива (за литр)',
  'settings.roadtrip.fuelPricePerGallon': 'Цена топлива (за галлон)',
  'settings.roadtrip.fuelCurrency': 'Валюта топлива',
  'settings.roadtrip.fuelConsumptionMetric': 'Расход топлива (л/100км)',
  'settings.roadtrip.fuelConsumptionImperial': 'Расход топлива (MPG)',
  'settings.roadtrip.tankSizeLitres': 'Объём бака (литры)',
  'settings.roadtrip.tankSizeGallons': 'Объём бака (галлоны)',
  'settings.roadtrip.drivingPreferences': 'Настройки вождения',
  'settings.roadtrip.maxDrivingHours': 'Макс. часов вождения',
  'settings.roadtrip.restInterval': 'Интервал отдыха (часы)',
  'settings.roadtrip.restDuration': 'Длительность отдыха (минуты)',
  'settings.roadtrip.maxSpeed': 'Максимальная скорость',
  ...
  'settings.roadtrip.routePreferences': 'Настройки маршрута',
  'settings.roadtrip.daylightOnly': 'Только в светлое время суток',
  'settings.roadtrip.roadPreference': 'Тип дороги',
  'settings.roadtrip.anyRoad': 'Любая дорога',
  'settings.roadtrip.sealedOnly': 'Только асфальтированные',
  'settings.roadtrip.fuelPreferences': 'Настройки топлива',
  'settings.roadtrip.fuelType': 'Тип топлива',
  'settings.roadtrip.fuelBrand': 'Предпочитаемый бренд',
  'settings.roadtrip.fuelTypeAny': 'Любое топливо',
  'settings.roadtrip.fuelTypeDiesel': 'Дизель',
  'settings.roadtrip.fuelTypePetrol': 'Бензин',
  'settings.roadtrip.brandAny': 'Любой бренд',
  'settings.roadtrip.brandPreferred': 'Предпочитаемый бренд — другие показываются при необходимости',
  'settings.roadtrip.avoidFerries': 'Избегать паромов',
  'settings.roadtrip.preferHighways': 'Предпочитать автомагистрали',
  'settings.roadtrip.truckSafe': 'Подходит для грузовиков / автодомов',
  'roadtrip.legActive': 'Маршрут автопутешествия активен',
  'roadtrip.markLeg': 'Отметить как этап автопутешествия',
  'roadtrip.toggleAll': 'Переключить все этапы автопутешествия',
  'roadtrip.summary': 'Сводка автопутешествия',
  'roadtrip.totalDistance': 'Общее расстояние',
  'roadtrip.totalTime': 'Время в пути',
  'roadtrip.totalFuel': 'Расходы на топливо',
  'roadtrip.day': 'День',
  'roadtrip.distance': 'Расстояние',
  'roadtrip.driveTime': 'Время в пути',
  'roadtrip.fuelCost': 'Топливо',
  'roadtrip.recalculateFuel': 'Пересчитать расходы на топливо',
  'roadtrip.recalculate': 'Пересчитать',
  'roadtrip.speedAdjusted': 'Время в пути скорректировано для максимальной скорости {speed}',
  'roadtrip.rangeWarning': 'Этот этап ({distance}) превышает запас хода вашего транспорта ({range}). Потребуется дозаправка.',
  'roadtrip.fuelStopsEstimate': 'Ожидаемые остановки для заправки: {count}',
  'roadtrip.exceedsRange': 'Превышает запас хода',
  'roadtrip.refuelPoint': 'Примерная точка заправки',
  'roadtrip.drivingTimeWarning': 'Время вождения ({actual}) превышает ваш дневной лимит {limit}',
  'roadtrip.restBreaks': '{count} перерывов (+{minutes} мин)',
  'roadtrip.restStop': 'Рекомендуемая остановка для отдыха',
  'roadtrip.totalWithBreaks': 'Итого с перерывами',
  'roadtrip.daylightWindow': '{sunrise} – {sunset} ({hours}ч)',
  'roadtrip.daylightWarning': 'Время вождения ({driving}) превышает световой день ({daylight})',
  'roadtrip.daylightMode': 'Режим дневного вождения активен',
  'roadtrip.truckSafeHelp': 'Требуется собственный сервер маршрутизации с профилем для грузовиков. Сервер по умолчанию использует маршрутизацию для легковых автомобилей.',
  'roadtrip.sealedOnlyHelp': 'Требуется пользовательский профиль маршрутизации. Сервер по умолчанию может включать грунтовые дороги.',
  'roadtrip.exceedsDaylight': 'Превышает доступные часы светлого времени',
  'roadtrip.estimatedRange': 'Расчётный запас хода: {range}',
  'roadtrip.driving': 'Вождение',
  'roadtrip.pdfDrivingSummary': 'Сводка вождения',
  'roadtrip.pdfTripTotal': 'Итого по поездке',
  'roadtrip.toggleAllTrip': 'Переключить все этапы автопутешествия',
  'roadtrip.calculatingRoutes': 'Расчёт маршрутов…',
  'roadtrip.showFullRoute': 'Показать весь маршрут поездки',
  'roadtrip.directions': 'Маршрут',
  'roadtrip.directionsOmitted': 'Маршрут опущен для этапов свыше 800 км',
  'roadtrip.directionCount': '{count} указаний',
  'roadtrip.arrive': 'Прибытие в пункт назначения',
  'roadtrip.depart': 'Отправление',
  'roadtrip.findStops': 'Найти остановки',
  'roadtrip.stopsFound': '{count} остановок найдено',
  'roadtrip.stopSource': 'Источник данных остановок',
  'roadtrip.stopSourceOsm': 'OpenStreetMap (бесплатно)',
  'roadtrip.stopSourceGoogle': 'Google Places (больше данных)',
  'roadtrip.stopSourceHelp': 'Источник для поиска заправок и зон отдыха вдоль маршрута.',
  'roadtrip.stopSourceGoogleDisabled': 'Google Places требует ключ API Google Maps, настроенный администратором.',
  'roadtrip.realFuelStop': 'заправка',
  'roadtrip.realRestStop': 'отдых',
  'roadtrip.openInMaps': 'Открыть в Google Maps',
  'roadtrip.approximateStop': 'Примерная остановка',
  'roadtrip.refreshStops': 'Обновить',
  'roadtrip.findingStops': 'Поиск остановок…',
  'roadtrip.recommendedDeparture': 'Выехать после',
  'roadtrip.arrivalBefore': 'Прибыть до',
  'roadtrip.drivingWindow': 'Окно для вождения',
  'roadtrip.departBy': 'Выезд в {time} · Прибытие в {arrival}',
  'roadtrip.insufficientDaylight': 'Недостаточно светового дня для этой поездки. Рассмотрите возможность разделить маршрут на два дня.',
  'roadtrip.setCheckout': 'Установить время выезда',
  'roadtrip.setCheckin': 'Установить время заезда',
  'roadtrip.checkoutUpdated': 'Время выезда обновлено',
  'roadtrip.checkinUpdated': 'Время заезда обновлено',
  'roadtrip.daylightOk': 'Дневное вождение ОК',
  'roadtrip.bookingsSafe': 'Ваш выезд ({checkout}) и заезд ({checkin}) находятся в безопасном дневном окне',
  'roadtrip.checkoutTooEarly': 'Выезд ({time}) раньше безопасного отъезда ({safe})',
  'roadtrip.checkinTooLate': 'Заезд ({time}) позже безопасного прибытия ({safe})',
  'roadtrip.criticalFuelStop': 'Необходима заправка',
  'roadtrip.optionalFuelStop': 'Доступно',
  'roadtrip.mustRefuel': 'ЗАПРАВИТЬ',
  'roadtrip.fuelAvailable': 'Доступно',
  'roadtrip.tripFuelPrice': 'Цена топлива',
  'roadtrip.tripFuelPriceHelp': 'Цена топлива для этой поездки',
  'roadtrip.tripOverride': 'цена поездки',
  'roadtrip.noPreferredBrand': 'Станции предпочитаемого бренда не найдены',
  'settings.roadtrip.stopSource': 'Поиск остановок',
  ...
  'atlas.roadTrips': 'Автопутешествия',
  'atlas.totalDriven': 'Всего проехано',
  'atlas.totalRoadTrips': 'Поездки',
  'atlas.totalDrivingTime': 'Время в пути',
  'atlas.totalFuelSpent': 'Расходы на топливо',
  'atlas.longestTrip': 'Самая длинная поездка',
  'atlas.longestDay': 'Самый длинный день',
  'atlas.tripLegend': 'Поездки',
  'atlas.viewTrip': 'Открыть поездку',
  'atlas.noRoadTrips': 'Пока нет данных об автопутешествиях. Отметьте участки как автопутешествия в планах поездок, чтобы увидеть их здесь.',

const ru: Record<string, string> = {
  ...
  'settings.mfa.backupCodesTitle': 'Сохраните резервные коды',
  'settings.mfa.backupCodesIntro': 'Одноразовые коды для входа, если потеряете аутентификатор. Каждый код действует один раз.',
  'settings.mfa.backupCodesWarning': 'Храните в надёжном месте. Мы показываем их только здесь, пока вы не создадите новые.',
  'settings.mfa.backupCodesCopyAll': 'Копировать все',
  'settings.mfa.backupCodesCopied': 'Скопировано в буфер',
  'settings.mfa.backupCodesPrint': 'Печать / Сохранить как PDF',
  'settings.mfa.backupCodesSaveTxt': 'Сохранить как .txt',
  'settings.mfa.backupCodesFileHeader': 'TREK — Резервные коды двухфакторной аутентификации\nКаждый код одноразовый. Храните файл в безопасном месте.',
  'settings.mfa.backupCodesPrintFooter': 'TREK — Каждый код одноразовый. Храните распечатку в безопасности.',
  'settings.mfa.backupCodesPrintBlocked': 'Не удалось открыть окно печати. Разрешите всплывающие окна для этого сайта.',
  'settings.mfa.backupCodesSavedTxt': 'Загрузка начата',
  'settings.mfa.backupCodesClose': 'Я сохранил(а) их',
  'settings.mfa.backupCodesRemaining': 'Осталось резервных кодов: {count}',
  'settings.mfa.backupCodesNone': 'Резервных кодов нет. Создайте новые ниже, если потеряли аутентификатор.',
  'settings.mfa.regenerateBackupTitle': 'Резервные коды',
  'settings.mfa.regenerateBackupHint': 'Введите пароль и текущий 6-значный код. Старые резервные коды перестанут действовать.',
  'settings.mfa.regenerateBackup': 'Создать новые резервные коды',
  'settings.mfa.toastBackupRegenerated': 'Созданы новые резервные коды',
  ...
  'login.mfaSubtitle': 'Введите 6-значный код или одноразовый резервный код.',
  'login.mfaCodeLabel': 'Код подтверждения',
  'login.mfaCodeRequired': 'Введите код аутентификатора или резервный код.',
  'login.mfaHint': 'Используйте приложение-аутентификатор или резервный код, если нет доступа.',

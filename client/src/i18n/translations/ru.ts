const ru: Record<string, string> = {
  ...
  'packing.type.shared': 'общая',
  'packing.type.personal': 'личная',
  'packing.type.private': 'приватная',
  'packing.type.shared.hint': 'Видно всем. Отметки общие.',
  'packing.type.personal.hint': 'Видно всем, но каждый управляет своими отметками.',
  'packing.type.private.hint': 'Только ты видишь эту категорию и её элементы.',
  'packing.type.makeShared': 'Сделать общей',
  'packing.type.makePersonal': 'Сделать личной',
  'packing.type.makePrivate': 'Сделать приватной',
  'packing.categoryExists': 'Категория уже существует',
  ...
  'packing.saveAsTemplate.hint': 'Приватные категории не включаются.',

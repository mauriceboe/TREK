const pl: Record<string, string | { name: string; category: string }[]> = {
  ...
  'packing.saveAsTemplate.hint': 'Kategorie prywatne nie są uwzględniane.',
  ...
  'packing.type.shared': 'wspólna',
  'packing.type.personal': 'osobista',
  'packing.type.private': 'prywatna',
  'packing.type.shared.hint': 'Widoczne dla wszystkich. Zaznaczenia są wspólne.',
  'packing.type.personal.hint': 'Widoczne dla wszystkich, ale każdy zarządza własnymi zaznaczeniami.',
  'packing.type.private.hint': 'Tylko ty widzisz tę kategorię i jej elementy.',
  'packing.type.makeShared': 'Ustaw jako wspólną',
  'packing.type.makePersonal': 'Ustaw jako osobistą',
  'packing.type.makePrivate': 'Ustaw jako prywatną',
  'packing.categoryExists': 'Kategoria już istnieje',

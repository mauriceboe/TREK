const cs: Record<string, string | { name: string; category: string }[]> = {
  ...
  'settings.roadtrip.title': 'Výlet autem',
  'settings.roadtrip.unitSystem': 'Systém jednotek',
  'settings.roadtrip.metric': 'Metrický',
  'settings.roadtrip.imperial': 'Imperiální',
  'settings.roadtrip.vehicle': 'Vozidlo',
  'settings.roadtrip.fuelPricePerLitre': 'Cena paliva (za litr)',
  'settings.roadtrip.fuelPricePerGallon': 'Cena paliva (za galon)',
  'settings.roadtrip.fuelCurrency': 'Měna paliva',
  'settings.roadtrip.fuelConsumptionMetric': 'Spotřeba paliva (L/100km)',
  'settings.roadtrip.fuelConsumptionImperial': 'Spotřeba paliva (MPG)',
  'settings.roadtrip.tankSizeLitres': 'Objem nádrže (litry)',
  'settings.roadtrip.tankSizeGallons': 'Objem nádrže (galony)',
  'settings.roadtrip.drivingPreferences': 'Předvolby jízdy',
  'settings.roadtrip.maxDrivingHours': 'Max. hodin jízdy',
  'settings.roadtrip.restInterval': 'Interval odpočinku (hodiny)',
  'settings.roadtrip.restDuration': 'Délka odpočinku (minuty)',
  'settings.roadtrip.maxSpeed': 'Maximální rychlost',
  'settings.roadtrip.maxSpeedHelp': 'Omezuje odhadované časy jízdy na silnicích s vyššími rychlostními limity. Ponechte prázdné pro použití značených limitů.',
  'settings.roadtrip.routePreferences': 'Předvolby trasy',
  'settings.roadtrip.daylightOnly': 'Jízda pouze za denního světla',
  'settings.roadtrip.roadPreference': 'Preference silnic',
  'settings.roadtrip.anyRoad': 'Jakákoli silnice',
  'settings.roadtrip.sealedOnly': 'Pouze zpevněné',
  'settings.roadtrip.fuelPreferences': 'Preference paliva',
  'settings.roadtrip.fuelType': 'Typ paliva',
  'settings.roadtrip.fuelBrand': 'Preferovaná značka',
  'settings.roadtrip.fuelTypeAny': 'Jakékoli palivo',
  'settings.roadtrip.fuelTypeDiesel': 'Nafta',
  'settings.roadtrip.fuelTypePetrol': 'Benzín',
  'settings.roadtrip.brandAny': 'Jakákoli značka',
  'settings.roadtrip.brandPreferred': 'Preferovaná značka — ostatní zobrazeny v případě potřeby',
  'settings.roadtrip.avoidFerries': 'Vyhnout se trajektům',
  'settings.roadtrip.preferHighways': 'Preferovat dálnice',
  'settings.roadtrip.truckSafe': 'Bezpečné pro nákladní / obytné vozy',
  'roadtrip.legActive': 'Trasa výletu aktivní',
  'roadtrip.markLeg': 'Označit jako úsek výletu',
  'roadtrip.toggleAll': 'Přepnout všechny úseky výletu',
  'roadtrip.summary': 'Souhrn výletu autem',
  'roadtrip.totalDistance': 'Celková vzdálenost',
  'roadtrip.totalTime': 'Doba jízdy',
  'roadtrip.totalFuel': 'Náklady na palivo',
  'roadtrip.day': 'Den',
  'roadtrip.distance': 'Vzdálenost',
  'roadtrip.driveTime': 'Doba jízdy',
  'roadtrip.fuelCost': 'Palivo',
  'roadtrip.recalculateFuel': 'Přepočítat náklady na palivo',
  'roadtrip.recalculate': 'Přepočítat',
  'roadtrip.speedAdjusted': 'Časy jízdy upraveny pro maximální rychlost {speed}',
  'roadtrip.rangeWarning': 'Tento úsek ({distance}) přesahuje dojezd vašeho vozidla ({range}). Bude nutné doplnit palivo.',
  'roadtrip.fuelStopsEstimate': 'Odhadované zastávky na tankování: {count}',
  'roadtrip.exceedsRange': 'Přesahuje dojezd vozidla',
  'roadtrip.refuelPoint': 'Přibližný bod tankování',
  'roadtrip.drivingTimeWarning': 'Doba jízdy ({actual}) přesahuje váš denní limit {limit}',
  'roadtrip.restBreaks': '{count} přestávek (+{minutes} min)',
  'roadtrip.restStop': 'Doporučená přestávka',
  'roadtrip.totalWithBreaks': 'Celkem s přestávkami',
  'roadtrip.daylightWindow': '{sunrise} – {sunset} ({hours}h)',
  'roadtrip.daylightWarning': 'Doba jízdy ({driving}) přesahuje denní světlo ({daylight})',
  'roadtrip.daylightMode': 'Režim jízdy za denního světla aktivní',
  'roadtrip.truckSafeHelp': 'Vyžaduje vlastní routovací server s profilem pro nákladní vozy. Výchozí server používá běžné routování pro osobní auta.',
  'roadtrip.sealedOnlyHelp': 'Vyžaduje vlastní routovací profil. Výchozí server může zahrnovat nezpevněné cesty.',
  'roadtrip.exceedsDaylight': 'Přesahuje dostupné hodiny denního světla',
  'roadtrip.estimatedRange': 'Odhadovaný dojezd: {range}',
  'roadtrip.driving': 'Jízda',
  'roadtrip.pdfDrivingSummary': 'Souhrn jízdy',
  'roadtrip.pdfTripTotal': 'Celkový výlet',
  'roadtrip.toggleAllTrip': 'Přepnout všechny úseky výletu',
  'roadtrip.calculatingRoutes': 'Výpočet tras…',
  'roadtrip.showFullRoute': 'Zobrazit celou trasu výletu',
  'roadtrip.directions': 'Navigace',
  'roadtrip.directionsOmitted': 'Navigace vynechána pro úseky delší než 800 km',
  'roadtrip.directionCount': '{count} pokynů',
  'roadtrip.arrive': 'Příjezd do cíle',
  'roadtrip.depart': 'Odjezd',
  'roadtrip.findStops': 'Hledat zastávky',
  'roadtrip.stopsFound': '{count} zastávek nalezeno',
  'roadtrip.stopSource': 'Zdroj dat zastávek',
  'roadtrip.stopSourceOsm': 'OpenStreetMap (zdarma)',
  'roadtrip.stopSourceGoogle': 'Google Places (bohatší data)',
  'roadtrip.stopSourceHelp': 'Zdroj pro vyhledávání čerpacích stanic a odpočívadel podél trasy.',
  'roadtrip.stopSourceGoogleDisabled': 'Google Places vyžaduje klíč API Google Maps nakonfigurovaný administrátorem.',
  'roadtrip.realFuelStop': 'čerpací stanice',
  'roadtrip.realRestStop': 'odpočívadlo',
  'roadtrip.openInMaps': 'Otevřít v Google Maps',
  'roadtrip.approximateStop': 'Přibližná zastávka',
  'roadtrip.refreshStops': 'Obnovit',
  'roadtrip.findingStops': 'Hledání zastávek…',
  'roadtrip.recommendedDeparture': 'Odjet po',
  'roadtrip.arrivalBefore': 'Přijet před',
  'roadtrip.drivingWindow': 'Časové okno jízdy',
  'roadtrip.departBy': 'Odjezd v {time} · Příjezd v {arrival}',
  'roadtrip.insufficientDaylight': 'Nedostatek denního světla pro tuto cestu. Zvažte rozdělení na dva dny.',
  'roadtrip.setCheckout': 'Nastavit check-out',
  'roadtrip.setCheckin': 'Nastavit check-in',
  'roadtrip.checkoutUpdated': 'Čas check-outu aktualizován',
  'roadtrip.checkinUpdated': 'Čas check-inu aktualizován',
  'roadtrip.daylightOk': 'Denní jízda OK',
  'roadtrip.bookingsSafe': 'Váš check-out ({checkout}) a check-in ({checkin}) jsou v bezpečném denním okně',
  'roadtrip.checkoutTooEarly': 'Check-out ({time}) je před bezpečným odjezdem ({safe})',
  'roadtrip.checkinTooLate': 'Check-in ({time}) je po bezpečném příjezdu ({safe})',
  'roadtrip.criticalFuelStop': 'Nutné tankovat',
  'roadtrip.optionalFuelStop': 'Dostupné',
  'roadtrip.mustRefuel': 'TANKOVAT',
  'roadtrip.fuelAvailable': 'Dostupné',
  'roadtrip.tripFuelPrice': 'Cena paliva',
  'roadtrip.tripFuelPriceHelp': 'Cena paliva specifická pro tuto cestu',
  'roadtrip.tripOverride': 'cena cesty',
  'roadtrip.noPreferredBrand': 'Nenalezeny stanice preferované značky',
  'settings.roadtrip.stopSource': 'Hledání zastávek',
  ...
  'atlas.roadTrips': 'Výlety autem',
  'atlas.totalDriven': 'Celkem najeto',
  'atlas.totalRoadTrips': 'Výlety',
  'atlas.totalDrivingTime': 'Doba jízdy',
  'atlas.totalFuelSpent': 'Náklady na palivo',
  'atlas.longestTrip': 'Nejdelší výlet',
  'atlas.longestDay': 'Nejdelší den',
  'atlas.tripLegend': 'Výlety',
  'atlas.viewTrip': 'Zobrazit výlet',
  'atlas.noRoadTrips': 'Zatím žádné údaje o výletech autem. Označte úseky jako výlety autem ve svých plánech, abyste je zde viděli.',

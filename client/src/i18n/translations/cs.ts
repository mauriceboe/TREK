const cs: Record<string, string | { name: string; category: string }[]> = {
  ...
  'packing.type.shared': 'sdílená',
  'packing.type.personal': 'osobní',
  'packing.type.private': 'soukromá',
  'packing.type.shared.hint': 'Viditelné pro všechny. Zaškrtnutí jsou sdílená.',
  'packing.type.personal.hint': 'Viditelné pro všechny, ale každý spravuje svá vlastní zaškrtnutí.',
  'packing.type.private.hint': 'Pouze ty vidíš tuto kategorii a její položky.',
  'packing.type.makeShared': 'Nastavit jako sdílenou',
  'packing.type.makePersonal': 'Nastavit jako osobní',
  'packing.type.makePrivate': 'Nastavit jako soukromou',
  'packing.categoryExists': 'Kategorie již existuje',
  ...
  'packing.saveAsTemplate.hint': 'Soukromé kategorie nejsou zahrnuty.',

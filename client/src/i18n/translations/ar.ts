...
const ar: Record<string, string | { name: string; category: string }[]> = {
  ...
  'settings.mfa.backupCodesTitle': 'احفظ رموز النسخ الاحتياطي',
  'settings.mfa.backupCodesIntro': 'رموز لمرة واحدة لتسجيل الدخول إذا فقدت تطبيق المصادقة. كل رمز يعمل مرة واحدة فقط.',
  'settings.mfa.backupCodesWarning': 'احفظها في مكان آمن. نعرضها هنا فقط ما لم تنشئ رموزًا جديدة.',
  'settings.mfa.backupCodesCopyAll': 'نسخ الكل',
  'settings.mfa.backupCodesCopied': 'تم النسخ إلى الحافظة',
  'settings.mfa.backupCodesPrint': 'طباعة / حفظ كـ PDF',
  'settings.mfa.backupCodesSaveTxt': 'حفظ كـ .txt',
  'settings.mfa.backupCodesFileHeader': 'TREK — رموز النسخ الاحتياطي للمصادقة الثنائية\nكل رمز لمرة واحدة. احفظ هذا الملف في مكان آمن.',
  'settings.mfa.backupCodesPrintFooter': 'TREK — كل رمز لمرة واحدة. احفظ هذه النسخة المطبوعة.',
  'settings.mfa.backupCodesPrintBlocked': 'تعذر فتح نافذة الطباعة. اسمح بالنوافذ المنبثقة لهذا الموقع.',
  'settings.mfa.backupCodesSavedTxt': 'بدأ التنزيل',
  'settings.mfa.backupCodesClose': 'لقد حفظتها',
  'settings.mfa.backupCodesRemaining': '{count} رموز نسخ احتياطي متبقية',
  'settings.mfa.backupCodesNone': 'لا توجد رموز نسخ احتياطي. أنشئ رموزًا جديدة أدناه إذا فقدت المصادقة.',
  'settings.mfa.regenerateBackupTitle': 'رموز النسخ الاحتياطي',
  'settings.mfa.regenerateBackupHint': 'أدخل كلمة المرور والرمز المكوّن من 6 أرقام. ستتوقف الرموز القديمة عن العمل.',
  'settings.mfa.regenerateBackup': 'إنشاء رموز نسخ احتياطي جديدة',
  'settings.mfa.toastBackupRegenerated': 'تم إنشاء رموز نسخ احتياطي جديدة',
  ...
  'login.mfaSubtitle': 'أدخل الرمز المكوّن من 6 أرقام أو رمز نسخ احتياطي لمرة واحدة.',
  'login.mfaCodeLabel': 'رمز التحقق',
  'login.mfaCodeRequired': 'أدخل رمز المصادقة أو رمز النسخ الاحتياطي.',
  'login.mfaHint': 'استخدم تطبيق المصادقة أو رمز النسخ الاحتياطي إذا فقدت الوصول.',

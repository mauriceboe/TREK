...
const ar: Record<string, string | { name: string; category: string }[]> = {
  ...
  'settings.roadtrip.title': 'رحلة برية',
  'settings.roadtrip.unitSystem': 'نظام الوحدات',
  'settings.roadtrip.metric': 'متري',
  'settings.roadtrip.imperial': 'إمبريالي',
  'settings.roadtrip.vehicle': 'المركبة',
  'settings.roadtrip.fuelPricePerLitre': 'سعر الوقود (لكل لتر)',
  'settings.roadtrip.fuelPricePerGallon': 'سعر الوقود (لكل غالون)',
  'settings.roadtrip.fuelCurrency': 'عملة الوقود',
  'settings.roadtrip.fuelConsumptionMetric': 'استهلاك الوقود (لتر/100 كم)',
  'settings.roadtrip.fuelConsumptionImperial': 'كفاءة الوقود (MPG)',
  'settings.roadtrip.tankSizeLitres': 'حجم خزان الوقود (لترات)',
  'settings.roadtrip.tankSizeGallons': 'حجم خزان الوقود (غالونات)',
  'settings.roadtrip.drivingPreferences': 'تفضيلات القيادة',
  'settings.roadtrip.maxDrivingHours': 'أقصى ساعات قيادة',
  'settings.roadtrip.restInterval': 'فترة الراحة (ساعات)',
  'settings.roadtrip.restDuration': 'مدة الراحة (دقائق)',
  'settings.roadtrip.maxSpeed': 'السرعة القصوى',
  'settings.roadtrip.maxSpeedHelp': 'يحدّ من أوقات القيادة المقدّرة على الطرق ذات حدود السرعة الأعلى. اتركه فارغاً لاستخدام حدود السرعة المنشورة.',
  'settings.roadtrip.routePreferences': 'تفضيلات المسار',
  'settings.roadtrip.daylightOnly': 'القيادة نهارًا فقط',
  'settings.roadtrip.roadPreference': 'تفضيل الطريق',
  'settings.roadtrip.anyRoad': 'أي طريق',
  'settings.roadtrip.sealedOnly': 'طرق معبّدة فقط',
  'settings.roadtrip.fuelPreferences': 'تفضيلات الوقود',
  'settings.roadtrip.fuelType': 'نوع الوقود',
  'settings.roadtrip.fuelBrand': 'العلامة التجارية المفضلة',
  'settings.roadtrip.fuelTypeAny': 'أي وقود',
  'settings.roadtrip.fuelTypeDiesel': 'ديزل',
  'settings.roadtrip.fuelTypePetrol': 'بنزين',
  'settings.roadtrip.brandAny': 'أي علامة تجارية',
  'settings.roadtrip.brandPreferred': 'العلامة التجارية المفضلة — تظهر العلامات الأخرى عند الحاجة',
  'settings.roadtrip.avoidFerries': 'تجنب العبّارات',
  'settings.roadtrip.preferHighways': 'تفضيل الطرق السريعة',
  'settings.roadtrip.truckSafe': 'آمن للشاحنات / المنازل المتنقلة',
  'roadtrip.legActive': 'مسار الرحلة البرية نشط',
  'roadtrip.markLeg': 'وضع علامة كمرحلة رحلة برية',
  'roadtrip.toggleAll': 'تبديل جميع مراحل الرحلة البرية',
  'roadtrip.summary': 'ملخص الرحلة البرية',
  'roadtrip.totalDistance': 'المسافة الإجمالية',
  'roadtrip.totalTime': 'وقت القيادة',
  'roadtrip.totalFuel': 'تكلفة الوقود',
  'roadtrip.day': 'يوم',
  'roadtrip.distance': 'المسافة',
  'roadtrip.driveTime': 'وقت القيادة',
  'roadtrip.fuelCost': 'الوقود',
  'roadtrip.recalculateFuel': 'إعادة حساب تكاليف الوقود',
  'roadtrip.recalculate': 'إعادة الحساب',
  'roadtrip.speedAdjusted': 'تم تعديل أوقات القيادة للسرعة القصوى {speed}',
  'roadtrip.rangeWarning': 'هذه المرحلة ({distance}) تتجاوز مدى مركبتك ({range}). ستحتاج إلى التزوّد بالوقود.',
  'roadtrip.fuelStopsEstimate': 'محطات التزوّد المقدّرة: {count}',
  'roadtrip.exceedsRange': 'يتجاوز مدى المركبة',
  'roadtrip.refuelPoint': 'نقطة تزوّد تقريبية',
  'roadtrip.drivingTimeWarning': 'وقت القيادة ({actual}) يتجاوز الحد اليومي {limit}',
  'roadtrip.restBreaks': '{count} استراحات (+{minutes} دقيقة)',
  'roadtrip.restStop': 'استراحة موصى بها',
  'roadtrip.totalWithBreaks': 'الإجمالي مع الاستراحات',
  'roadtrip.daylightWindow': '{sunrise} – {sunset} ({hours} ساعة)',
  'roadtrip.daylightWarning': 'وقت القيادة ({driving}) يتجاوز ساعات النهار ({daylight})',
  'roadtrip.daylightMode': 'وضع القيادة النهارية نشط',
  'roadtrip.truckSafeHelp': 'يتطلب خادم توجيه مستضاف ذاتيًا بملف تعريف الشاحنات. الخادم الافتراضي يستخدم توجيه السيارات القياسي.',
  'roadtrip.sealedOnlyHelp': 'يتطلب ملف تعريف توجيه مخصصًا. قد يتضمن الخادم الافتراضي طرقًا غير معبّدة.',
  'roadtrip.exceedsDaylight': 'يتجاوز ساعات النهار المتاحة',
  'roadtrip.estimatedRange': 'المدى المقدّر: {range}',
  'roadtrip.driving': 'القيادة',
  'roadtrip.pdfDrivingSummary': 'ملخص القيادة',
  'roadtrip.pdfTripTotal': 'إجمالي الرحلة',
  'roadtrip.toggleAllTrip': 'تبديل جميع مراحل الرحلة البرية',
  'roadtrip.calculatingRoutes': 'جارٍ حساب المسارات…',
  'roadtrip.showFullRoute': 'عرض مسار الرحلة الكامل',
  'roadtrip.directions': 'الاتجاهات',
  'roadtrip.directionsOmitted': 'تم حذف الاتجاهات للمراحل التي تزيد عن 800 كم',
  'roadtrip.directionCount': '{count} اتجاهات',
  'roadtrip.arrive': 'الوصول إلى الوجهة',
  'roadtrip.depart': 'المغادرة',
  'roadtrip.findStops': 'البحث عن محطات',
  'roadtrip.stopsFound': 'تم العثور على {count} محطات',
  'roadtrip.stopSource': 'مصدر بيانات المحطات',
  'roadtrip.stopSourceOsm': 'OpenStreetMap (مجاني)',
  'roadtrip.stopSourceGoogle': 'Google Places (بيانات أغنى)',
  'roadtrip.stopSourceHelp': 'مصدر للبحث عن محطات الوقود ومناطق الاستراحة على طول الطريق.',
  'roadtrip.stopSourceGoogleDisabled': 'يتطلب Google Places مفتاح API لخرائط Google تم تكوينه بواسطة المسؤول.',
  'roadtrip.realFuelStop': 'محطة وقود',
  'roadtrip.realRestStop': 'استراحة',
  'roadtrip.openInMaps': 'فتح في خرائط Google',
  'roadtrip.approximateStop': 'محطة تقريبية',
  'roadtrip.refreshStops': 'تحديث',
  'roadtrip.findingStops': 'جارٍ البحث عن محطات…',
  'roadtrip.recommendedDeparture': 'المغادرة بعد',
  'roadtrip.arrivalBefore': 'الوصول قبل',
  'roadtrip.drivingWindow': 'نافذة القيادة',
  'roadtrip.departBy': 'المغادرة في {time} · الوصول في {arrival}',
  'roadtrip.insufficientDaylight': 'لا يوجد ضوء نهار كافٍ لهذه الرحلة. فكّر في تقسيمها على يومين.',
  'roadtrip.setCheckout': 'تعيين وقت المغادرة',
  'roadtrip.setCheckin': 'تعيين وقت الوصول',
  'roadtrip.checkoutUpdated': 'تم تحديث وقت المغادرة',
  'roadtrip.checkinUpdated': 'تم تحديث وقت الوصول',
  'roadtrip.daylightOk': 'القيادة النهارية موافق',
  'roadtrip.bookingsSafe': 'وقت المغادرة ({checkout}) ووقت الوصول ({checkin}) ضمن نافذة ضوء النهار الآمنة',
  'roadtrip.checkoutTooEarly': 'وقت المغادرة ({time}) قبل الانطلاق الآمن ({safe})',
  'roadtrip.checkinTooLate': 'وقت الوصول ({time}) بعد الوصول الآمن ({safe})',
  'roadtrip.criticalFuelStop': 'يجب التزود بالوقود',
  'roadtrip.optionalFuelStop': 'متاح',
  'roadtrip.mustRefuel': 'تزود بالوقود',
  'roadtrip.fuelAvailable': 'متاح',
  'roadtrip.tripFuelPrice': 'سعر الوقود',
  'roadtrip.tripFuelPriceHelp': 'تعيين سعر وقود خاص بهذه الرحلة',
  'roadtrip.tripOverride': 'سعر الرحلة',
  'roadtrip.noPreferredBrand': 'لم يتم العثور على محطات العلامة التجارية المفضلة',
  'settings.roadtrip.stopSource': 'بحث المحطات',
  ...
  'atlas.roadTrips': 'رحلات بالسيارة',
  'atlas.totalDriven': 'إجمالي المسافة',
  'atlas.totalRoadTrips': 'رحلات',
  'atlas.totalDrivingTime': 'وقت القيادة',
  'atlas.totalFuelSpent': 'تكلفة الوقود',
  'atlas.longestTrip': 'أطول رحلة',
  'atlas.longestDay': 'أطول يوم',
  'atlas.tripLegend': 'رحلات',
  'atlas.viewTrip': 'عرض الرحلة',
  'atlas.noRoadTrips': 'لا توجد بيانات رحلات بالسيارة بعد. حدد المراحل كرحلات بالسيارة في خطط سفرك لرؤيتها هنا.',

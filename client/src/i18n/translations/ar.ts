...
const ar: Record<string, string | { name: string; category: string }[]> = {
  ...
  'packing.type.shared': 'مشترك',
  'packing.type.personal': 'شخصي',
  'packing.type.private': 'خاص',
  'packing.type.shared.hint': 'مرئي للجميع. علامات التحقق مشتركة.',
  'packing.type.personal.hint': 'مرئي للجميع، لكن كل شخص يدير علامات التحقق الخاصة به.',
  'packing.type.private.hint': 'أنت فقط من يرى هذه الفئة وعناصرها.',
  'packing.type.makeShared': 'جعله مشتركًا',
  'packing.type.makePersonal': 'جعله شخصيًا',
  'packing.type.makePrivate': 'جعله خاصًا',
  'packing.categoryExists': 'الفئة موجودة بالفعل',
  ...
  'packing.saveAsTemplate.hint': 'لا يتم تضمين الفئات الخاصة.',

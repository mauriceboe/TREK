const es: Record<string, string> = {
  ...
  'settings.mfa.backupCodesTitle': 'Guarda tus códigos de respaldo',
  'settings.mfa.backupCodesIntro': 'Códigos de un solo uso para iniciar sesión si pierdes el autenticador. Cada código solo sirve una vez.',
  'settings.mfa.backupCodesWarning': 'Guárdalos en un lugar seguro. Solo los mostramos aquí salvo que generes otros nuevos.',
  'settings.mfa.backupCodesCopyAll': 'Copiar todos',
  'settings.mfa.backupCodesCopied': 'Copiado al portapapeles',
  'settings.mfa.backupCodesPrint': 'Imprimir / Guardar como PDF',
  'settings.mfa.backupCodesSaveTxt': 'Guardar como .txt',
  'settings.mfa.backupCodesFileHeader': 'TREK — Códigos de respaldo de autenticación en dos pasos\nCada código es de un solo uso. Guarda este archivo en un lugar seguro.',
  'settings.mfa.backupCodesPrintFooter': 'TREK — Cada código es de un solo uso. Conserva esta copia impresa.',
  'settings.mfa.backupCodesPrintBlocked': 'No se pudo abrir la ventana de impresión. Permite ventanas emergentes en este sitio.',
  'settings.mfa.backupCodesSavedTxt': 'Descarga iniciada',
  'settings.mfa.backupCodesClose': 'Ya los guardé',
  'settings.mfa.backupCodesRemaining': '{count} códigos de respaldo restantes',
  'settings.mfa.backupCodesNone': 'Sin códigos de respaldo. Genera nuevos abajo si pierdes el autenticador.',
  'settings.mfa.regenerateBackupTitle': 'Códigos de respaldo',
  'settings.mfa.regenerateBackupHint': 'Introduce tu contraseña y el código de 6 dígitos actual. Los códigos anteriores dejarán de valer.',
  'settings.mfa.regenerateBackup': 'Generar nuevos códigos de respaldo',
  'settings.mfa.toastBackupRegenerated': 'Nuevos códigos de respaldo generados',
  ...
  'login.mfaSubtitle': 'Introduce el código de 6 dígitos o un código de respaldo de un solo uso.',
  'login.mfaCodeLabel': 'Código de verificación',
  'login.mfaCodeRequired': 'Introduce el código del autenticador o un código de respaldo.',
  'login.mfaHint': 'Usa tu app de autenticación o un código de respaldo si no tienes acceso.',

const es: Record<string, string> = {
  ...
  'settings.roadtrip.title': 'Viaje por carretera',
  'settings.roadtrip.unitSystem': 'Sistema de unidades',
  'settings.roadtrip.metric': 'Métrico',
  'settings.roadtrip.imperial': 'Imperial',
  'settings.roadtrip.vehicle': 'Vehículo',
  'settings.roadtrip.fuelPricePerLitre': 'Precio del combustible (por litro)',
  'settings.roadtrip.fuelPricePerGallon': 'Precio del combustible (por galón)',
  'settings.roadtrip.fuelCurrency': 'Moneda del combustible',
  'settings.roadtrip.fuelConsumptionMetric': 'Consumo de combustible (L/100km)',
  'settings.roadtrip.fuelConsumptionImperial': 'Rendimiento de combustible (MPG)',
  'settings.roadtrip.tankSizeLitres': 'Tamaño del tanque (litros)',
  'settings.roadtrip.tankSizeGallons': 'Tamaño del tanque (galones)',
  'settings.roadtrip.drivingPreferences': 'Preferencias de conducción',
  'settings.roadtrip.maxDrivingHours': 'Horas máximas de conducción',
  'settings.roadtrip.restInterval': 'Intervalo de descanso (horas)',
  'settings.roadtrip.restDuration': 'Duración del descanso (minutos)',
  'settings.roadtrip.maxSpeed': 'Velocidad máxima',
  'settings.roadtrip.maxSpeedHelp': 'Limita los tiempos de conducción estimados en carreteras con límites de velocidad más altos. Dejar vacío para usar los límites publicados.',
  'settings.roadtrip.routePreferences': 'Preferencias de ruta',
  'settings.roadtrip.daylightOnly': 'Conducir solo de día',
  'settings.roadtrip.roadPreference': 'Preferencia de camino',
  'settings.roadtrip.anyRoad': 'Cualquier camino',
  'settings.roadtrip.sealedOnly': 'Solo pavimentado',
  'settings.roadtrip.fuelPreferences': 'Preferencias de combustible',
  'settings.roadtrip.fuelType': 'Tipo de combustible',
  'settings.roadtrip.fuelBrand': 'Marca preferida',
  'settings.roadtrip.fuelTypeAny': 'Cualquier combustible',
  'settings.roadtrip.fuelTypeDiesel': 'Diésel',
  'settings.roadtrip.fuelTypePetrol': 'Gasolina',
  'settings.roadtrip.brandAny': 'Cualquier marca',
  'settings.roadtrip.brandPreferred': 'Marca preferida — otras se muestran si es necesario',
  'settings.roadtrip.avoidFerries': 'Evitar ferris',
  'settings.roadtrip.preferHighways': 'Preferir autopistas',
  'settings.roadtrip.truckSafe': 'Apto para camiones / autocaravanas',
  'roadtrip.legActive': 'Ruta de viaje activa',
  'roadtrip.markLeg': 'Marcar como tramo del viaje',
  'roadtrip.toggleAll': 'Alternar todos los tramos del viaje',
  'roadtrip.summary': 'Resumen del viaje por carretera',
  'roadtrip.totalDistance': 'Distancia total',
  'roadtrip.totalTime': 'Tiempo de conducción',
  'roadtrip.totalFuel': 'Coste de combustible',
  'roadtrip.day': 'Día',
  'roadtrip.distance': 'Distancia',
  'roadtrip.driveTime': 'Tiempo de conducción',
  'roadtrip.fuelCost': 'Combustible',
  'roadtrip.recalculateFuel': 'Recalcular costes de combustible',
  'roadtrip.recalculate': 'Recalcular',
  'roadtrip.speedAdjusted': 'Tiempos de conducción ajustados para velocidad máxima de {speed}',
  'roadtrip.rangeWarning': 'Este tramo ({distance}) supera la autonomía de tu vehículo ({range}). Será necesario repostar.',
  'roadtrip.fuelStopsEstimate': 'Paradas de repostaje estimadas: {count}',
  'roadtrip.exceedsRange': 'Supera la autonomía del vehículo',
  'roadtrip.refuelPoint': 'Punto de repostaje aproximado',
  'roadtrip.drivingTimeWarning': 'El tiempo de conducción ({actual}) supera tu límite diario de {limit}',
  'roadtrip.restBreaks': '{count} paradas de descanso (+{minutes} min)',
  'roadtrip.restStop': 'Parada de descanso recomendada',
  'roadtrip.totalWithBreaks': 'Total con descansos',
  'roadtrip.daylightWindow': '{sunrise} – {sunset} ({hours}h)',
  'roadtrip.daylightWarning': 'La conducción ({driving}) supera las horas de luz ({daylight})',
  'roadtrip.daylightMode': 'Modo de conducción diurna activo',
  'roadtrip.truckSafeHelp': 'Requiere un servidor de rutas propio con perfil para camiones. El servidor predeterminado usa rutas estándar para coches.',
  'roadtrip.sealedOnlyHelp': 'Requiere un perfil de rutas personalizado. El servidor predeterminado puede incluir caminos sin pavimentar.',
  'roadtrip.exceedsDaylight': 'Supera las horas de luz disponibles',
  'roadtrip.estimatedRange': 'Autonomía estimada: {range}',
  'roadtrip.driving': 'Conducción',
  'roadtrip.pdfDrivingSummary': 'Resumen de conducción',
  'roadtrip.pdfTripTotal': 'Total del viaje',
  'roadtrip.toggleAllTrip': 'Alternar todos los tramos del viaje',
  'roadtrip.calculatingRoutes': 'Calculando rutas…',
  'roadtrip.showFullRoute': 'Mostrar ruta completa del viaje',
  'roadtrip.directions': 'Indicaciones',
  'roadtrip.directionsOmitted': 'Indicaciones omitidas para tramos de más de 800 km',
  'roadtrip.directionCount': '{count} indicaciones',
  'roadtrip.arrive': 'Llegar al destino',
  'roadtrip.depart': 'Salida',
  'roadtrip.findStops': 'Buscar paradas',
  'roadtrip.stopsFound': '{count} paradas encontradas',
  'roadtrip.stopSource': 'Fuente de datos de paradas',
  'roadtrip.stopSourceOsm': 'OpenStreetMap (gratis)',
  'roadtrip.stopSourceGoogle': 'Google Places (más datos)',
  'roadtrip.stopSourceHelp': 'Fuente para búsqueda de gasolineras y áreas de descanso a lo largo de la ruta.',
  'roadtrip.stopSourceGoogleDisabled': 'Google Places requiere una clave API de Google Maps configurada por el administrador.',
  'roadtrip.realFuelStop': 'gasolinera',
  'roadtrip.realRestStop': 'descanso',
  'roadtrip.openInMaps': 'Abrir en Google Maps',
  'roadtrip.approximateStop': 'Parada aproximada',
  'roadtrip.refreshStops': 'Actualizar',
  'roadtrip.findingStops': 'Buscando paradas…',
  'roadtrip.recommendedDeparture': 'Salir después de',
  'roadtrip.arrivalBefore': 'Llegar antes de',
  'roadtrip.drivingWindow': 'Ventana de conducción',
  'roadtrip.departBy': 'Salir a las {time} · Llegar a las {arrival}',
  'roadtrip.insufficientDaylight': 'No hay suficiente luz del día para este viaje. Considera dividirlo en dos días.',
  'roadtrip.setCheckout': 'Establecer check-out',
  'roadtrip.setCheckin': 'Establecer check-in',
  'roadtrip.checkoutUpdated': 'Hora de check-out actualizada',
  'roadtrip.checkinUpdated': 'Hora de check-in actualizada',
  'roadtrip.daylightOk': 'Conducción diurna OK',
  'roadtrip.bookingsSafe': 'Tu check-out ({checkout}) y check-in ({checkin}) están dentro de la ventana segura de luz',
  'roadtrip.checkoutTooEarly': 'Check-out ({time}) es antes de la salida segura ({safe})',
  'roadtrip.checkinTooLate': 'Check-in ({time}) es después de la llegada segura ({safe})',
  'roadtrip.criticalFuelStop': 'Debe repostar',
  'roadtrip.optionalFuelStop': 'Disponible',
  'roadtrip.mustRefuel': 'REPOSTAR',
  'roadtrip.fuelAvailable': 'Disponible',
  'roadtrip.tripFuelPrice': 'Precio del combustible',
  'roadtrip.tripFuelPriceHelp': 'Precio de combustible específico para este viaje',
  'roadtrip.tripOverride': 'precio del viaje',
  'roadtrip.noPreferredBrand': 'No se encontraron estaciones de la marca preferida',
  'settings.roadtrip.stopSource': 'Búsqueda de paradas',
  ...
  'atlas.roadTrips': 'Viajes por carretera',
  'atlas.totalDriven': 'Total conducido',
  'atlas.totalRoadTrips': 'Viajes',
  'atlas.totalDrivingTime': 'Tiempo de conducción',
  'atlas.totalFuelSpent': 'Gasto en combustible',
  'atlas.longestTrip': 'Viaje más largo',
  'atlas.longestDay': 'Día más largo',
  'atlas.tripLegend': 'Viajes',
  'atlas.viewTrip': 'Ver viaje',
  'atlas.noRoadTrips': 'Aún no hay datos de viajes por carretera. Marca etapas como viajes por carretera en tus planes para verlos aquí.',

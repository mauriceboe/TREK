const id: Record<string, string | { name: string; category: string }[]> = {
  ...
  'packing.type.shared': 'bersama',
  'packing.type.personal': 'pribadi',
  'packing.type.private': 'rahasia',
  'packing.type.shared.hint': 'Terlihat oleh semua orang. Centang dibagikan.',
  'packing.type.personal.hint': 'Terlihat oleh semua orang, tetapi masing-masing mengelola centangnya sendiri.',
  'packing.type.private.hint': 'Hanya Anda yang dapat melihat kategori dan itemnya.',
  'packing.type.makeShared': 'Jadikan bersama',
  'packing.type.makePersonal': 'Jadikan pribadi',
  'packing.type.makePrivate': 'Jadikan rahasia',
  'packing.categoryExists': 'Kategori sudah ada',
  ...
  'packing.saveAsTemplate.hint': 'Kategori rahasia tidak disertakan.',

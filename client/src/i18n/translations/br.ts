const br: Record<string, string | { name: string; category: string }[]> = {
  ...
  'settings.roadtrip.title': 'Viagem de carro',
  'settings.roadtrip.unitSystem': 'Sistema de unidades',
  'settings.roadtrip.metric': 'Métrico',
  'settings.roadtrip.imperial': 'Imperial',
  'settings.roadtrip.vehicle': 'Veículo',
  'settings.roadtrip.fuelPricePerLitre': 'Preço do combustível (por litro)',
  'settings.roadtrip.fuelPricePerGallon': 'Preço do combustível (por galão)',
  'settings.roadtrip.fuelCurrency': 'Moeda do combustível',
  'settings.roadtrip.fuelConsumptionMetric': 'Consumo de combustível (L/100km)',
  'settings.roadtrip.fuelConsumptionImperial': 'Rendimento de combustível (MPG)',
  'settings.roadtrip.tankSizeLitres': 'Capacidade do tanque (litros)',
  'settings.roadtrip.tankSizeGallons': 'Capacidade do tanque (galões)',
  'settings.roadtrip.drivingPreferences': 'Preferências de direção',
  'settings.roadtrip.maxDrivingHours': 'Horas máximas de direção',
  'settings.roadtrip.restInterval': 'Intervalo de descanso (horas)',
  'settings.roadtrip.restDuration': 'Duração do descanso (minutos)',
  'settings.roadtrip.maxSpeed': 'Velocidade máxima',
  'settings.roadtrip.maxSpeedHelp': 'Limita os tempos de condução estimados em estradas com limites de velocidade mais altos. Deixe vazio para usar os limites sinalizados.',
  'settings.roadtrip.routePreferences': 'Preferências de rota',
  'settings.roadtrip.daylightOnly': 'Dirigir somente de dia',
  'settings.roadtrip.roadPreference': 'Preferência de estrada',
  'settings.roadtrip.anyRoad': 'Qualquer estrada',
  'settings.roadtrip.sealedOnly': 'Somente pavimentada',
  'settings.roadtrip.fuelPreferences': 'Preferências de combustível',
  'settings.roadtrip.fuelType': 'Tipo de combustível',
  'settings.roadtrip.fuelBrand': 'Marca preferida',
  'settings.roadtrip.fuelTypeAny': 'Qualquer combustível',
  'settings.roadtrip.fuelTypeDiesel': 'Diesel',
  'settings.roadtrip.fuelTypePetrol': 'Gasolina',
  'settings.roadtrip.brandAny': 'Qualquer marca',
  'settings.roadtrip.brandPreferred': 'Marca preferida — outras exibidas se necessário',
  'settings.roadtrip.avoidFerries': 'Evitar balsas',
  'settings.roadtrip.preferHighways': 'Preferir rodovias',
  'settings.roadtrip.truckSafe': 'Seguro para caminhão / motorhome',
  'roadtrip.legActive': 'Rota da viagem ativa',
  'roadtrip.markLeg': 'Marcar como trecho da viagem',
  'roadtrip.toggleAll': 'Alternar todos os trechos da viagem',
  'roadtrip.summary': 'Resumo da viagem de carro',
  'roadtrip.totalDistance': 'Distância total',
  'roadtrip.totalTime': 'Tempo de direção',
  'roadtrip.totalFuel': 'Custo de combustível',
  'roadtrip.day': 'Dia',
  'roadtrip.distance': 'Distância',
  'roadtrip.driveTime': 'Tempo de direção',
  'roadtrip.fuelCost': 'Combustível',
  'roadtrip.recalculateFuel': 'Recalcular custos de combustível',
  'roadtrip.recalculate': 'Recalcular',
  'roadtrip.speedAdjusted': 'Tempos de condução ajustados para velocidade máxima de {speed}',
  'roadtrip.rangeWarning': 'Este trecho ({distance}) excede a autonomia do seu veículo ({range}). Será necessário reabastecer.',
  'roadtrip.fuelStopsEstimate': 'Paradas para abastecimento estimadas: {count}',
  'roadtrip.exceedsRange': 'Excede a autonomia do veículo',
  'roadtrip.refuelPoint': 'Ponto de abastecimento aproximado',
  'roadtrip.drivingTimeWarning': 'O tempo de direção ({actual}) excede o seu limite diário de {limit}',
  'roadtrip.restBreaks': '{count} paradas de descanso (+{minutes} min)',
  'roadtrip.restStop': 'Parada de descanso recomendada',
  'roadtrip.totalWithBreaks': 'Total com paradas',
  'roadtrip.daylightWindow': '{sunrise} – {sunset} ({hours}h)',
  'roadtrip.daylightWarning': 'A direção ({driving}) excede as horas de luz ({daylight})',
  'roadtrip.daylightMode': 'Modo direção diurna ativo',
  'roadtrip.truckSafeHelp': 'Requer um servidor de rotas próprio com perfil para caminhões. O servidor padrão usa rotas de carro convencional.',
  'roadtrip.sealedOnlyHelp': 'Requer um perfil de rotas personalizado. O servidor padrão pode incluir estradas não pavimentadas.',
  'roadtrip.exceedsDaylight': 'Excede as horas de luz disponíveis',
  'roadtrip.estimatedRange': 'Autonomia estimada: {range}',
  'roadtrip.driving': 'Direção',
  'roadtrip.pdfDrivingSummary': 'Resumo de direção',
  'roadtrip.pdfTripTotal': 'Total da viagem',
  'roadtrip.toggleAllTrip': 'Alternar todos os trechos da viagem',
  'roadtrip.calculatingRoutes': 'Calculando rotas…',
  'roadtrip.showFullRoute': 'Mostrar rota completa da viagem',
  'roadtrip.directions': 'Direções',
  'roadtrip.directionsOmitted': 'Direções omitidas para trechos acima de 800 km',
  'roadtrip.directionCount': '{count} direções',
  'roadtrip.arrive': 'Chegar ao destino',
  'roadtrip.depart': 'Partida',
  'roadtrip.findStops': 'Buscar paradas',
  'roadtrip.stopsFound': '{count} paradas encontradas',
  'roadtrip.stopSource': 'Fonte de dados de paradas',
  'roadtrip.stopSourceOsm': 'OpenStreetMap (gratuito)',
  'roadtrip.stopSourceGoogle': 'Google Places (dados mais ricos)',
  'roadtrip.stopSourceHelp': 'Fonte para busca de postos de combustível e áreas de descanso ao longo da rota.',
  'roadtrip.stopSourceGoogleDisabled': 'Google Places requer uma chave de API do Google Maps configurada pelo administrador.',
  'roadtrip.realFuelStop': 'posto',
  'roadtrip.realRestStop': 'descanso',
  'roadtrip.openInMaps': 'Abrir no Google Maps',
  'roadtrip.approximateStop': 'Parada aproximada',
  'roadtrip.refreshStops': 'Atualizar',
  'roadtrip.findingStops': 'Buscando paradas…',
  'roadtrip.recommendedDeparture': 'Partir depois de',
  'roadtrip.arrivalBefore': 'Chegar antes de',
  'roadtrip.drivingWindow': 'Janela de direção',
  'roadtrip.departBy': 'Partir às {time} · Chegar às {arrival}',
  'roadtrip.insufficientDaylight': 'Luz do dia insuficiente para esta viagem. Considere dividir em dois dias.',
  'roadtrip.setCheckout': 'Definir check-out',
  'roadtrip.setCheckin': 'Definir check-in',
  'roadtrip.checkoutUpdated': 'Horário de check-out atualizado',
  'roadtrip.checkinUpdated': 'Horário de check-in atualizado',
  'roadtrip.daylightOk': 'Condução diurna OK',
  'roadtrip.bookingsSafe': 'Seu check-out ({checkout}) e check-in ({checkin}) estão dentro da janela segura de luz do dia',
  'roadtrip.checkoutTooEarly': 'Check-out ({time}) é antes da partida segura ({safe})',
  'roadtrip.checkinTooLate': 'Check-in ({time}) é após a chegada segura ({safe})',
  'roadtrip.criticalFuelStop': 'Deve abastecer',
  'roadtrip.optionalFuelStop': 'Disponível',
  'roadtrip.mustRefuel': 'ABASTECER',
  'roadtrip.fuelAvailable': 'Disponível',
  'roadtrip.tripFuelPrice': 'Preço do combustível',
  'roadtrip.tripFuelPriceHelp': 'Preço de combustível específico para esta viagem',
  'roadtrip.tripOverride': 'preço da viagem',
  'roadtrip.noPreferredBrand': 'Nenhum posto da marca preferida encontrado',
  'settings.roadtrip.stopSource': 'Busca de paradas',
  ...
  'atlas.roadTrips': 'Viagens de carro',
  'atlas.totalDriven': 'Total percorrido',
  'atlas.totalRoadTrips': 'Viagens',
  'atlas.totalDrivingTime': 'Tempo de direção',
  'atlas.totalFuelSpent': 'Gasto com combustível',
  'atlas.longestTrip': 'Maior viagem',
  'atlas.longestDay': 'Maior dia',
  'atlas.tripLegend': 'Viagens',
  'atlas.viewTrip': 'Ver viagem',
  'atlas.noRoadTrips': 'Ainda não há dados de viagens de carro. Marque trechos como viagens de carro nos seus planos para vê-los aqui.',

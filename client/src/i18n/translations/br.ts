const br: Record<string, string | { name: string; category: string }[]> = {
  ...
  'packing.saveAsTemplate.hint': 'Categorias privadas não são incluídas.',
  ...
  'packing.type.shared': 'compartilhado',
  'packing.type.personal': 'pessoal',
  'packing.type.private': 'privado',
  'packing.type.shared.hint': 'Visível para todos. As marcações são compartilhadas.',
  'packing.type.personal.hint': 'Visível para todos, mas cada pessoa gerencia suas próprias marcações.',
  'packing.type.private.hint': 'Apenas você vê esta categoria e seus itens.',
  'packing.type.makeShared': 'Tornar compartilhado',
  'packing.type.makePersonal': 'Tornar pessoal',
  'packing.type.makePrivate': 'Tornar privado',
  'packing.categoryExists': 'Categoria já existe',

...
const places: TranslationStrings = {
  ...
  'places.osmActiveAmap': '正在使用 OpenStreetMap。新增高德 API 金鑰可獲得評分和營業時間。',
  'places.osmActiveAny': '正在使用 OpenStreetMap。新增 Google 或高德 API 金鑰可獲得評分和營業時間。',
  ...
  'places.details.noKeyHintAmap': '沒有高德 API 金鑰時，此實例僅使用免費來源。請聯絡 TREK 管理員新增金鑰，以取得評分和營業時間。',
  'places.details.noKeyHintAny': '沒有 Google 或高德 API 金鑰時，此實例僅使用免費來源。請聯絡 TREK 管理員新增金鑰，以取得評分和營業時間。',

...
const places: TranslationStrings = {
  ...
  'places.osmActiveAmap': '正在使用 OpenStreetMap。添加高德 API 密钥可获得评分和营业时间。',
  'places.osmActiveAny': '正在使用 OpenStreetMap。添加 Google 或高德 API 密钥可获得评分和营业时间。',
  ...
  'places.details.noKeyHintAmap': '没有高德 API 密钥时，此实例仅使用免费来源。请联系 TREK 管理员添加密钥，以获取评分和营业时间。',
  'places.details.noKeyHintAny': '没有 Google 或高德 API 密钥时，此实例仅使用免费来源。请联系 TREK 管理员添加密钥，以获取评分和营业时间。',
